...
public interface StrategyManagerAdminMBean extends AdminCommand {

    public String resumeAll();
    /**
     * dont process market data or exchange data events
     */
    public String fullPauseAll();

    /**
     * dont generate new orders other than get out of active orders when paused
     */
    ...
    /**
     * @WARNING ONLY FOR EXTREME USE CASES ... DANGEROUS WILL FORCE STRAT TO STOP CATCHUP AND HENCE HAS POTENTIAL LOSS
     */
