 ...
 */
public interface BookSubscriptionMgr<T extends Book> extends BookListener<T>, SMTComponent {

    /**
     * associate requested book to 
     * 
     * @param callback
     * @param securityDescription
     * @return
     */
    public T subscribe( BookListener<T> callback, Instrument inst );
