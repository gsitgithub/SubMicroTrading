...
public class T1Main extends BaseSMTMain {
    ...
    private static final Logger    _console         = LoggerFactory.console( T1Main.class );
    ...
    protected void init() throws SessionException, FileException, PersisterException {
        ...
        ExchangeContainerAdapter exchangeInboundHandler = new ExchangeContainerAdapter();
    ...
    private CMEMarketDataController getProcesssor( Session hub ) {
