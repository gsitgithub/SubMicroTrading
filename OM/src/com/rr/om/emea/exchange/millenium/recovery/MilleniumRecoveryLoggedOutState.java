...
public class MilleniumRecoveryLoggedOutState implements SessionState {

    private static final Logger  _log = LoggerFactory.create( MilleniumRecoveryLoggedOutState.class );
    ...
    public MilleniumRecoveryLoggedOutState( SeqNumSession session, MilleniumRecoveryController sessionController, MilleniumSocketConfig config ) {
        _session          = session;
    ...
    public void handle( Message msg ) throws SessionStateException {
        ...
        if ( msg.getReusableType().getSubId() == EventIds.ID_MILLENIUMLOGON ) {
            ...
            if ( rep.getRejectCode() != 0 ) {
                ...
                _controller.sendReplayRequests();
            }
