...
public class DummyExchangeManager {
    ...
    private final Map<ZString, Exchange> _exchanges;

    public static DummyExchangeManager instance() { return _instance;  }
    
    private DummyExchangeManager() {
        _exchanges = new HashMap<ZString, Exchange>();
    }

    public Exchange get( ZString ex ) {
        
        Exchange e = _exchanges.get( ex );
        
        if ( e == null ) {
            
            ReusableString rec = new ReusableString(ex);
            
            e = new DummyExchange( rec, null, false );
            
            _exchanges.put( rec, e );
        }
