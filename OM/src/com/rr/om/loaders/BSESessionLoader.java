...
public class BSESessionLoader extends BaseSessionLoader {
    ...
    public SMTComponent create( String id ) throws SMTException {
        ...
        try {
            ...
            ETIBSEEncoder       encoder           = (ETIBSEEncoder) getEncoder( _codecId, outBuf, logHdrOut, _trace ); 
            ETIBSEDecoder       decoder           = (ETIBSEDecoder) getRecoveryDecoder( _codecId, _clientProfile, _trace );
            ETIBSEDecoder       recoveryDecoder   = (ETIBSEDecoder) getRecoveryDecoder( _codecId, _clientProfile, false );
    ...
    protected ETISocketSession createETISession( CodecId codecId,
        ...
        Decoder             recDecoder           = getRecoveryDecoder( codecId, _clientProfile, _trace );
