...
echo "RUN: $PRERUN java $JVM_ARGS -classpath $CLASSPATH com.rr.om.itch.ITCHMulticastSampleServer $PROG_ARGS"

$PRERUN java $JVM_ARGS -classpath $CLASSPATH com.rr.om.itch.ITCHMulticastSampleServer $PROG_ARGS
