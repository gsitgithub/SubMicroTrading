...
echo "RUN: $PRERUN java $JVM_ARGS -classpath $CLASSPATH com.rr.core.socket.MulticastPingClient $PROG_ARGS"

$PRERUN java $JVM_ARGS -classpath $CLASSPATH com.rr.core.socket.MulticastPingClient $PROG_ARGS
