...
# msgsToSend  delayUSEC  cpuMask   debug{1|0} qos msgSize  NIC

PROG_ARGS="1000 1000 128 0 8 12 192.168.10.2"
...
echo "RUN: $PRERUN java $JVM_ARGS -classpath $CLASSPATH com.rr.core.socket.TCP $PROG_ARGS"

# $PRERUN java $JVM_ARGS -classpath $CLASSPATH com.rr.core.progs.PingPongServer 4321

$PRERUN java $JVM_ARGS -classpath $CLASSPATH com.rr.core.socket.TCPPingServer $PROG_ARGS
