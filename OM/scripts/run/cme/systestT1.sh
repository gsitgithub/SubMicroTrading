...
PROG_ARGS="./config/fastfix/cme/systestT1.properties"
...
echo "RUN: $PRERUN java $JVM_ARGS -classpath $CLASSPATH com.rr.om.main.T1Main $PROG_ARGS"

nohup $PRERUN java $JVM_ARGS -classpath $CLASSPATH com.rr.om.main.T1Main $PROG_ARGS >logs/server.log 2>&1 &
