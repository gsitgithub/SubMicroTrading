...
# msgsToSend  serverIP  cpuMask  debug{1|0}  qos  msgSize
PROG_ARGS="100000 192.168.10.2 4 0 8 12"
...
# $PRERUN java $JVM_ARGS -classpath $CLASSPATH com.rr.core.progs.PingPongClient 4321

$PRERUN java $JVM_ARGS -classpath $CLASSPATH com.rr.core.socket.TCPPingClient $PROG_ARGS
