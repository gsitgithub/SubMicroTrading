...
# msgsToSend  NIC  cpuMask  spin{1|0}  disableLoopback{1|0}  debug{1|0}   qos   msgSize
PROG_ARGS="100000 192.168.10.1 4 1 1 0 8 16"
...
echo "RUN: $PRERUN java $JVM_ARGS -classpath $CLASSPATH com.rr.om.itch.ITCHMulticastSampleClient $PROG_ARGS"

$PRERUN java $JVM_ARGS -classpath $CLASSPATH com.rr.om.itch.ITCHMulticastSampleClient $PROG_ARGS
