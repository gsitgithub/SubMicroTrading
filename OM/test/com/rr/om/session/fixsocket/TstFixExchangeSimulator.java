...
public class TstFixExchangeSimulator extends BaseFixSimProcess {
            ...
            static final Logger      _log     = LoggerFactory.console( TstFixExchangeSimulator.class );
    ...
    protected void init() throws SessionException, FileException, PersisterException, IOException {
        ...
        MessageDispatcher dispatcher = new ThreadedDispatcher( "WarmupExchangeSimAdapter", queue, ThreadPriority.ExchangeSimProcessor );
    ...
    private FixSocketSession createExchangeSession( int expOrders, WarmupExchangeSimAdapter exSimAdapter ) throws SessionException, PersisterException {
        ...
        MessageDispatcher dispatcher = getSessionDispatcher( "EX_DISPATCHER", ThreadPriority.ExchangeSimulatorOut ); 
