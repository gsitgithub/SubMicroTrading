...
public class TestWarmupFixSocketSession extends BaseTestCase {
    ...
    public void testWarmupFixSocket() {
        ...
        LoggerFactory.initLogging( "./logs/TstWarmupFixSocketSession.log", 1000000 );        
        ...
        try {
            ...
            WarmupFixSocketSession sess = WarmupFixSocketSession.create( "Test", 0, false, orders, CodecId.Standard44 );
