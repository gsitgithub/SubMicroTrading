...
public final class RecoveryDoneForDayImpl implements CommonExecRpt, MarketDoneForDayWrite, Reusable<RecoveryDoneForDayImpl> {

   // Attrs

    private          RecoveryDoneForDayImpl _next = null;
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.RecoveryDoneForDay;
    }

    @Override
    public final RecoveryDoneForDayImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( RecoveryDoneForDayImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( ReusableString out ) {
        out.append( "RecoveryDoneForDayImpl" ).append( ' ' );
