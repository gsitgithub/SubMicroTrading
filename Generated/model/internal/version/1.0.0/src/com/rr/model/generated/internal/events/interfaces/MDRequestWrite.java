...
public interface MDRequestWrite extends BaseMDRequest, MDRequest {

   // Getters and Setters
    public void setMdReqId( byte[] buf, int offset, int len );
    public ReusableString getMdReqIdForUpdate();

    public void setSubsReqType( SubsReqType val );

    public void setMarketDepth( int val );

    public void setNumRelatedSym( int val );

    public void setSymbolGrp( SymbolRepeatingGrp val );
