...
public final class MarketSuspendedImpl implements CommonExecRpt, MarketSuspendedWrite, Reusable<MarketSuspendedImpl> {
   ...
   // Getters and Setters
    ...
    @Override public ViewString getSecurityId() { throw new IllegalFieldAccess( "Getter for securityId event Suspended is a delegate field from order request base" ); }


    @Override public ViewString getSymbol() { throw new IllegalFieldAccess( "Getter for symbol event Suspended is a delegate field from order request base" ); }


    @Override public Currency getCurrency() { throw new IllegalFieldAccess( "Getter for currency event Suspended is a delegate field from order request base" ); }


    @Override public SecurityIDSource getSecurityIDSource() { throw new IllegalFieldAccess( "Getter for securityIDSource event Suspended is a delegate field from order request base" ); }
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.MarketSuspended;
    }

    @Override
    public final MarketSuspendedImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( MarketSuspendedImpl nxt ) {
        _next = nxt;
    }
