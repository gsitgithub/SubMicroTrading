...
public final class ETISubscribeResponseImpl implements BaseETIResponse, ETISubscribeResponseWrite, Reusable<ETISubscribeResponseImpl> {

   // Attrs

    private          ETISubscribeResponseImpl _next = null;
    ...
    private int _applSubID = Constants.UNSET_INT;
   ...
   // Getters and Setters
    ...
    @Override public final int getApplSubID() { return _applSubID; }
    @Override public final void setApplSubID( int val ) { _applSubID = val; }
   ...
   // Reusable Contract
    ...
    public final void reset() {
        ...
        _applSubID = Constants.UNSET_INT;
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.ETISubscribeResponse;
    }

    @Override
    public final ETISubscribeResponseImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( ETISubscribeResponseImpl nxt ) {
        _next = nxt;
    }
