...
public final class ETIUserLogonResponseImpl implements BaseETIResponse, ETIUserLogonResponseWrite, Reusable<ETIUserLogonResponseImpl> {

   // Attrs

    private          ETIUserLogonResponseImpl _next = null;
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.ETIUserLogonResponse;
    }

    @Override
    public final ETIUserLogonResponseImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( ETIUserLogonResponseImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( ReusableString out ) {
        out.append( "ETIUserLogonResponseImpl" ).append( ' ' );
