...
public final class MarketExpiredImpl implements CommonExecRpt, MarketExpiredWrite, Reusable<MarketExpiredImpl> {

   // Attrs

    private          MarketExpiredImpl _next = null;
   ...
   // Getters and Setters
    ...
    @Override public ViewString getSecurityId() { throw new IllegalFieldAccess( "Getter for securityId event Expired is a delegate field from order request base" ); }


    @Override public ViewString getSymbol() { throw new IllegalFieldAccess( "Getter for symbol event Expired is a delegate field from order request base" ); }


    @Override public Currency getCurrency() { throw new IllegalFieldAccess( "Getter for currency event Expired is a delegate field from order request base" ); }


    @Override public SecurityIDSource getSecurityIDSource() { throw new IllegalFieldAccess( "Getter for securityIDSource event Expired is a delegate field from order request base" ); }
    ...
    @Override public int getOrderQty() { throw new IllegalFieldAccess( "Getter for orderQty event Expired is a delegate field from order request base" ); }


    @Override public double getPrice() { throw new IllegalFieldAccess( "Getter for price event Expired is a delegate field from order request base" ); }
    ...
    @Override public ViewString getOnBehalfOfId() { throw new IllegalFieldAccess( "Getter for onBehalfOfId event Expired is a delegate field from order request base" ); }
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.MarketExpired;
    }

    @Override
    public final MarketExpiredImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( MarketExpiredImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( ReusableString out ) {
        out.append( "MarketExpiredImpl" ).append( ' ' );
