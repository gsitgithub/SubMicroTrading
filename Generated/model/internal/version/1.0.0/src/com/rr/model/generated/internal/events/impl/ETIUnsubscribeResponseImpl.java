...
public final class ETIUnsubscribeResponseImpl implements BaseETIResponse, ETIUnsubscribeResponseWrite, Reusable<ETIUnsubscribeResponseImpl> {

   // Attrs

    private          ETIUnsubscribeResponseImpl _next = null;
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.ETIUnsubscribeResponse;
    }

    @Override
    public final ETIUnsubscribeResponseImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( ETIUnsubscribeResponseImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( ReusableString out ) {
        out.append( "ETIUnsubscribeResponseImpl" ).append( ' ' );
