...
public final class ClientDoneForDayImpl implements CommonExecRpt, ClientDoneForDayUpdate, Reusable<ClientDoneForDayImpl> {

   // Attrs

    private          ClientDoneForDayImpl _next = null;
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.ClientDoneForDay;
    }

    @Override
    public final ClientDoneForDayImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( ClientDoneForDayImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( ReusableString out ) {
        out.append( "ClientDoneForDayImpl" ).append( ' ' );
