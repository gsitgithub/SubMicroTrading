...
public final class RecoveryForceCancelImpl implements ClientForceCancelWrite, Reusable<RecoveryForceCancelImpl> {

   // Attrs

    private          RecoveryForceCancelImpl _next = null;
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.RecoveryForceCancel;
    }

    @Override
    public final RecoveryForceCancelImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( RecoveryForceCancelImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( ReusableString out ) {
        out.append( "RecoveryForceCancelImpl" ).append( ' ' );
