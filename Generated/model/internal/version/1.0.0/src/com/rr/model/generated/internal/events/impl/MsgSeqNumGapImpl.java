...
public final class MsgSeqNumGapImpl implements MsgSeqNumGapWrite, Reusable<MsgSeqNumGapImpl> {

   // Attrs

    private          MsgSeqNumGapImpl _next = null;
   ...
   // Helper methods
    ...
    public final void dump( ReusableString out ) {
        ...
        out.append( ", channelId=" ).append( getChannelId() );
        out.append( ", msgSeqNum=" ).append( getMsgSeqNum() );
        out.append( ", prevSeqNum=" ).append( getPrevSeqNum() );
