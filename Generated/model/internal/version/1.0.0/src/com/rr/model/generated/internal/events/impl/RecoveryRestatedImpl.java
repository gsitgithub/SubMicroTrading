...
public final class RecoveryRestatedImpl implements CommonExecRpt, MarketRestatedWrite, Reusable<RecoveryRestatedImpl> {

   // Attrs

    private          RecoveryRestatedImpl _next = null;
   ...
   // Getters and Setters
    ...
    public final void setExecRestatementReason( ExecRestatementReason val ) { _execRestatementReason = val; }
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.RecoveryRestated;
    }

    @Override
    public final RecoveryRestatedImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( RecoveryRestatedImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( ReusableString out ) {
        out.append( "RecoveryRestatedImpl" ).append( ' ' );
