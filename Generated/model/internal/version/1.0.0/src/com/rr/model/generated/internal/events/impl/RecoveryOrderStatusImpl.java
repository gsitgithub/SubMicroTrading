...
public final class RecoveryOrderStatusImpl implements CommonExecRpt, MarketOrderStatusWrite, Reusable<RecoveryOrderStatusImpl> {

   // Attrs

    private          RecoveryOrderStatusImpl _next = null;
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.RecoveryOrderStatus;
    }

    @Override
    public final RecoveryOrderStatusImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( RecoveryOrderStatusImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( ReusableString out ) {
        out.append( "RecoveryOrderStatusImpl" ).append( ' ' );
