...
public final class MarketDoneForDayImpl implements CommonExecRpt, MarketDoneForDayWrite, Reusable<MarketDoneForDayImpl> {

   // Attrs

    private          MarketDoneForDayImpl _next = null;
   ...
   // Getters and Setters
    ...
    @Override public ViewString getSecurityId() { throw new IllegalFieldAccess( "Getter for securityId event DoneForDay is a delegate field from order request base" ); }


    @Override public ViewString getSymbol() { throw new IllegalFieldAccess( "Getter for symbol event DoneForDay is a delegate field from order request base" ); }


    @Override public Currency getCurrency() { throw new IllegalFieldAccess( "Getter for currency event DoneForDay is a delegate field from order request base" ); }


    @Override public SecurityIDSource getSecurityIDSource() { throw new IllegalFieldAccess( "Getter for securityIDSource event DoneForDay is a delegate field from order request base" ); }
    ...
    @Override public int getOrderQty() { throw new IllegalFieldAccess( "Getter for orderQty event DoneForDay is a delegate field from order request base" ); }


    @Override public double getPrice() { throw new IllegalFieldAccess( "Getter for price event DoneForDay is a delegate field from order request base" ); }
    ...
    @Override public ViewString getOnBehalfOfId() { throw new IllegalFieldAccess( "Getter for onBehalfOfId event DoneForDay is a delegate field from order request base" ); }
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.MarketDoneForDay;
    }

    @Override
    public final MarketDoneForDayImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( MarketDoneForDayImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( ReusableString out ) {
        out.append( "MarketDoneForDayImpl" ).append( ' ' );
