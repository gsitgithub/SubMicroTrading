...
public final class RecoveryNewOrderAckImpl implements CommonExecRpt, MarketNewOrderAckWrite, Reusable<RecoveryNewOrderAckImpl> {

   // Attrs

    private          RecoveryNewOrderAckImpl _next = null;
   ...
   // Getters and Setters
    ...
    public final void setAckReceived( long val ) { _ackReceived = val; }
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.RecoveryNewOrderAck;
    }

    @Override
    public final RecoveryNewOrderAckImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( RecoveryNewOrderAckImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( ReusableString out ) {
        out.append( "RecoveryNewOrderAckImpl" ).append( ' ' );
