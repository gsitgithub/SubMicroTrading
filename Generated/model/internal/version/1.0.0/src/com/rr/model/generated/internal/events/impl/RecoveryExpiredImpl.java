...
public final class RecoveryExpiredImpl implements CommonExecRpt, MarketExpiredWrite, Reusable<RecoveryExpiredImpl> {

   // Attrs

    private          RecoveryExpiredImpl _next = null;
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.RecoveryExpired;
    }

    @Override
    public final RecoveryExpiredImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( RecoveryExpiredImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( ReusableString out ) {
        out.append( "RecoveryExpiredImpl" ).append( ' ' );
