...
public final class MarketVagueOrderRejectImpl implements CommonExchangeHeader, MarketVagueOrderRejectWrite, Reusable<MarketVagueOrderRejectImpl> {

   // Attrs

    private          MarketVagueOrderRejectImpl _next = null;
   ...
   // Getters and Setters
    ...
    @Override public ViewString getOnBehalfOfId() { throw new IllegalFieldAccess( "Getter for onBehalfOfId event VagueOrderReject is a delegate field from order request base" ); }
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.MarketVagueOrderReject;
    }

    @Override
    public final MarketVagueOrderRejectImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( MarketVagueOrderRejectImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( ReusableString out ) {
        out.append( "MarketVagueOrderRejectImpl" ).append( ' ' );
