...
public final class ClientReplacedImpl implements CommonExecRpt, ClientReplacedUpdate, Reusable<ClientReplacedImpl> {

   // Attrs

    private          ClientReplacedImpl _next = null;
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.ClientReplaced;
    }

    @Override
    public final ClientReplacedImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( ClientReplacedImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( ReusableString out ) {
        out.append( "ClientReplacedImpl" ).append( ' ' );
