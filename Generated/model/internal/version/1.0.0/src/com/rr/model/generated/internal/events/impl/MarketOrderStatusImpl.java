...
public final class MarketOrderStatusImpl implements CommonExecRpt, MarketOrderStatusWrite, Reusable<MarketOrderStatusImpl> {

   // Attrs

    private          MarketOrderStatusImpl _next = null;
   ...
   // Getters and Setters
    ...
    @Override public ViewString getSecurityId() { throw new IllegalFieldAccess( "Getter for securityId event OrderStatus is a delegate field from order request base" ); }


    @Override public ViewString getSymbol() { throw new IllegalFieldAccess( "Getter for symbol event OrderStatus is a delegate field from order request base" ); }


    @Override public Currency getCurrency() { throw new IllegalFieldAccess( "Getter for currency event OrderStatus is a delegate field from order request base" ); }


    @Override public SecurityIDSource getSecurityIDSource() { throw new IllegalFieldAccess( "Getter for securityIDSource event OrderStatus is a delegate field from order request base" ); }
    ...
    @Override public int getOrderQty() { throw new IllegalFieldAccess( "Getter for orderQty event OrderStatus is a delegate field from order request base" ); }


    @Override public double getPrice() { throw new IllegalFieldAccess( "Getter for price event OrderStatus is a delegate field from order request base" ); }
    ...
    @Override public ViewString getOnBehalfOfId() { throw new IllegalFieldAccess( "Getter for onBehalfOfId event OrderStatus is a delegate field from order request base" ); }
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.MarketOrderStatus;
    }

    @Override
    public final MarketOrderStatusImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( MarketOrderStatusImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( ReusableString out ) {
        out.append( "MarketOrderStatusImpl" ).append( ' ' );
