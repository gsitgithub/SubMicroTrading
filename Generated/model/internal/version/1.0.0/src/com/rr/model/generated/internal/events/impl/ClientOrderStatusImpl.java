...
public final class ClientOrderStatusImpl implements CommonExecRpt, ClientOrderStatusUpdate, Reusable<ClientOrderStatusImpl> {

   // Attrs

    private          ClientOrderStatusImpl _next = null;
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.ClientOrderStatus;
    }

    @Override
    public final ClientOrderStatusImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( ClientOrderStatusImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( ReusableString out ) {
        out.append( "ClientOrderStatusImpl" ).append( ' ' );
