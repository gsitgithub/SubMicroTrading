...
public final class ClientAlertTradeMissingOrdersImpl implements Alert, ClientAlertTradeMissingOrdersUpdate, Reusable<ClientAlertTradeMissingOrdersImpl> {

   // Attrs

    private          ClientAlertTradeMissingOrdersImpl _next = null;
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.ClientAlertTradeMissingOrders;
    }

    @Override
    public final ClientAlertTradeMissingOrdersImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( ClientAlertTradeMissingOrdersImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( ReusableString out ) {
        out.append( "ClientAlertTradeMissingOrdersImpl" ).append( ' ' );
