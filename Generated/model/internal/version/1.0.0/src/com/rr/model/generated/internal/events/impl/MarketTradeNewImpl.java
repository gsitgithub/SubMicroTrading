...
public final class MarketTradeNewImpl implements TradeBase, MarketTradeNewWrite, Reusable<MarketTradeNewImpl> {
   ...
   // Attrs
    ...
    private          MarketTradeNewImpl _next = null;
   ...
   // Getters and Setters
    ...
    @Override public int getOrderQty() { throw new IllegalFieldAccess( "Getter for orderQty event TradeNew is a delegate field from order request base" ); }
