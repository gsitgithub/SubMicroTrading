...
public final class ETIUserLogoutRequestImpl implements BaseETIRequest, ETIUserLogoutRequestWrite, Reusable<ETIUserLogoutRequestImpl> {

   // Attrs

    private          ETIUserLogoutRequestImpl _next = null;
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.ETIUserLogoutRequest;
    }

    @Override
    public final ETIUserLogoutRequestImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( ETIUserLogoutRequestImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( ReusableString out ) {
        out.append( "ETIUserLogoutRequestImpl" ).append( ' ' );
