...
public final class UTPLogonImpl implements BaseUTP, UTPLogonWrite, Reusable<UTPLogonImpl> {

   // Attrs

    private          UTPLogonImpl _next = null;
    private volatile Message        _nextMessage    = null;
    private          MessageHandler _messageHandler = null;
    private int _lastMsgSeqNum = Constants.UNSET_INT;
    private final ReusableString _userName = new ReusableString( SizeType.UTP_TEXT_LENGTH.getSize() );
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.UTPLogon;
    }

    @Override
    public final UTPLogonImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( UTPLogonImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( ReusableString out ) {
        out.append( "UTPLogonImpl" ).append( ' ' );
