...
public final class RecoveryCancelledImpl implements CommonExecRpt, MarketCancelledWrite, Reusable<RecoveryCancelledImpl> {

   // Attrs

    private          RecoveryCancelledImpl _next = null;
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.RecoveryCancelled;
    }

    @Override
    public final RecoveryCancelledImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( RecoveryCancelledImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( ReusableString out ) {
        out.append( "RecoveryCancelledImpl" ).append( ' ' );
