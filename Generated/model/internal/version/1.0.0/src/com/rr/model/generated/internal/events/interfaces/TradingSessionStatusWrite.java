...
public interface TradingSessionStatusWrite extends SessionHeader, TradingSessionStatus {

   // Getters and Setters
    public void setMarketSegmentID( int val );

    public void setTradingSessionID( TradingSessionID val );

    public void setTradingSessionSubID( TradingSessionSubID val );

    public void setTradSesStatus( TradSesStatus val );
