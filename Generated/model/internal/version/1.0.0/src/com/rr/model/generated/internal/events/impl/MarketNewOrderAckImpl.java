...
public final class MarketNewOrderAckImpl implements CommonExecRpt, MarketNewOrderAckWrite, Reusable<MarketNewOrderAckImpl> {

   // Attrs

    private          MarketNewOrderAckImpl _next = null;
   ...
   // Getters and Setters
    ...
    @Override public long getOrderReceived() { throw new IllegalFieldAccess( "Getter for orderReceived event NewOrderAck is a delegate field from order request base" ); }


    @Override public long getOrderSent() { throw new IllegalFieldAccess( "Getter for orderSent event NewOrderAck is a delegate field from order request base" ); }
    ...
    @Override public ViewString getSecurityId() { throw new IllegalFieldAccess( "Getter for securityId event NewOrderAck is a delegate field from order request base" ); }


    @Override public ViewString getSymbol() { throw new IllegalFieldAccess( "Getter for symbol event NewOrderAck is a delegate field from order request base" ); }


    @Override public Currency getCurrency() { throw new IllegalFieldAccess( "Getter for currency event NewOrderAck is a delegate field from order request base" ); }


    @Override public SecurityIDSource getSecurityIDSource() { throw new IllegalFieldAccess( "Getter for securityIDSource event NewOrderAck is a delegate field from order request base" ); }
    ...
    @Override public int getOrderQty() { throw new IllegalFieldAccess( "Getter for orderQty event NewOrderAck is a delegate field from order request base" ); }


    @Override public double getPrice() { throw new IllegalFieldAccess( "Getter for price event NewOrderAck is a delegate field from order request base" ); }
    ...
    @Override public ViewString getOnBehalfOfId() { throw new IllegalFieldAccess( "Getter for onBehalfOfId event NewOrderAck is a delegate field from order request base" ); }
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.MarketNewOrderAck;
    }

    @Override
    public final MarketNewOrderAckImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( MarketNewOrderAckImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( ReusableString out ) {
        out.append( "MarketNewOrderAckImpl" ).append( ' ' );
