...
public final class RecoveryTradeCorrectImpl implements TradeBase, MarketTradeCorrectWrite, Reusable<RecoveryTradeCorrectImpl> {

   // Attrs

    private          RecoveryTradeCorrectImpl _next = null;
   ...
   // Getters and Setters
    ...
    public final void setOrigQty( int val ) { _origQty = val; }

    @Override public final double getOrigPx() { return _origPx; }
    public final void setOrigPx( double val ) { _origPx = val; }
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.RecoveryTradeCorrect;
    }

    @Override
    public final RecoveryTradeCorrectImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( RecoveryTradeCorrectImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( ReusableString out ) {
        out.append( "RecoveryTradeCorrectImpl" ).append( ' ' );
