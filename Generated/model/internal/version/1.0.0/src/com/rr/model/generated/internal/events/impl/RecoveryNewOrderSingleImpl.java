...
public final class RecoveryNewOrderSingleImpl implements OrderRequest, ClientNewOrderSingleWrite, Reusable<RecoveryNewOrderSingleImpl> {

   // Attrs

    private          RecoveryNewOrderSingleImpl _next = null;
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.RecoveryNewOrderSingle;
    }

    @Override
    public final RecoveryNewOrderSingleImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( RecoveryNewOrderSingleImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( ReusableString out ) {
        out.append( "RecoveryNewOrderSingleImpl" ).append( ' ' );
