...
public final class ClientRestatedImpl implements CommonExecRpt, ClientRestatedUpdate, Reusable<ClientRestatedImpl> {

   // Attrs

    private          ClientRestatedImpl _next = null;
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.ClientRestated;
    }

    @Override
    public final ClientRestatedImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( ClientRestatedImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( ReusableString out ) {
        out.append( "ClientRestatedImpl" ).append( ' ' );
