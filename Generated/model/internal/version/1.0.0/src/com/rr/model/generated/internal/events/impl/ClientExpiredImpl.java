...
public final class ClientExpiredImpl implements CommonExecRpt, ClientExpiredUpdate, Reusable<ClientExpiredImpl> {

   // Attrs

    private          ClientExpiredImpl _next = null;
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.ClientExpired;
    }

    @Override
    public final ClientExpiredImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( ClientExpiredImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( ReusableString out ) {
        out.append( "ClientExpiredImpl" ).append( ' ' );
