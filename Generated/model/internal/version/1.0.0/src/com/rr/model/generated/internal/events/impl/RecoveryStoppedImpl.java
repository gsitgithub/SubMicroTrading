...
public final class RecoveryStoppedImpl implements CommonExecRpt, MarketStoppedWrite, Reusable<RecoveryStoppedImpl> {

   // Attrs

    private          RecoveryStoppedImpl _next = null;
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.RecoveryStopped;
    }

    @Override
    public final RecoveryStoppedImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( RecoveryStoppedImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( ReusableString out ) {
        out.append( "RecoveryStoppedImpl" ).append( ' ' );
