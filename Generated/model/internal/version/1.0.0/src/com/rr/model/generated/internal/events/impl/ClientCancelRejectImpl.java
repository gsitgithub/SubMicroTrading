...
public final class ClientCancelRejectImpl implements CommonExchangeHeader, ClientCancelRejectUpdate, Reusable<ClientCancelRejectImpl> {

   // Attrs

    private          ClientCancelRejectImpl _next = null;
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.ClientCancelReject;
    }

    @Override
    public final ClientCancelRejectImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( ClientCancelRejectImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( ReusableString out ) {
        out.append( "ClientCancelRejectImpl" ).append( ' ' );
