...
public final class ClientTradeCorrectImpl implements TradeBase, ClientTradeCorrectUpdate, Reusable<ClientTradeCorrectImpl> {

   // Attrs

    private          ClientTradeCorrectImpl _next = null;
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.ClientTradeCorrect;
    }

    @Override
    public final ClientTradeCorrectImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( ClientTradeCorrectImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( ReusableString out ) {
        out.append( "ClientTradeCorrectImpl" ).append( ' ' );
