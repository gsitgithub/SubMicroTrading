...
public final class RecoveryTradeNewImpl implements TradeBase, MarketTradeNewWrite, Reusable<RecoveryTradeNewImpl> {

   // Attrs

    private          RecoveryTradeNewImpl _next = null;
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.RecoveryTradeNew;
    }

    @Override
    public final RecoveryTradeNewImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( RecoveryTradeNewImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( ReusableString out ) {
        out.append( "RecoveryTradeNewImpl" ).append( ' ' );
