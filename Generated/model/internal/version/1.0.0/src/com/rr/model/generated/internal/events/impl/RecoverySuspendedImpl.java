...
public final class RecoverySuspendedImpl implements CommonExecRpt, MarketSuspendedWrite, Reusable<RecoverySuspendedImpl> {

   // Attrs

    private          RecoverySuspendedImpl _next = null;
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.RecoverySuspended;
    }

    @Override
    public final RecoverySuspendedImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( RecoverySuspendedImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( ReusableString out ) {
        out.append( "RecoverySuspendedImpl" ).append( ' ' );
