...
public final class RecoveryReplacedImpl implements CommonExecRpt, MarketReplacedWrite, Reusable<RecoveryReplacedImpl> {

   // Attrs

    private          RecoveryReplacedImpl _next = null;
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.RecoveryReplaced;
    }

    @Override
    public final RecoveryReplacedImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( RecoveryReplacedImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( ReusableString out ) {
        out.append( "RecoveryReplacedImpl" ).append( ' ' );
