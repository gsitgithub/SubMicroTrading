...
public final class SecurityDefinitionImpl implements BaseMDResponse, SecurityDefinitionWrite, Reusable<SecurityDefinitionImpl> {

   // Attrs

    private          SecurityDefinitionImpl _next = null;
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.SecurityDefinition;
    }

    @Override
    public final SecurityDefinitionImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( SecurityDefinitionImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( ReusableString out ) {
        out.append( "SecurityDefinitionImpl" ).append( ' ' );
