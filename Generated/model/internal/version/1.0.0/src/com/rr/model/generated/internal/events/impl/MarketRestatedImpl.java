...
public final class MarketRestatedImpl implements CommonExecRpt, MarketRestatedWrite, Reusable<MarketRestatedImpl> {

   // Attrs

    private          MarketRestatedImpl _next = null;
    ...
    private ExecRestatementReason _execRestatementReason;
   ...
   // Getters and Setters
    @Override public final ExecRestatementReason getExecRestatementReason() { return _execRestatementReason; }
    @Override public final void setExecRestatementReason( ExecRestatementReason val ) { _execRestatementReason = val; }
    ...
    @Override public ViewString getSecurityId() { throw new IllegalFieldAccess( "Getter for securityId event Restated is a delegate field from order request base" ); }


    @Override public ViewString getSymbol() { throw new IllegalFieldAccess( "Getter for symbol event Restated is a delegate field from order request base" ); }


    @Override public Currency getCurrency() { throw new IllegalFieldAccess( "Getter for currency event Restated is a delegate field from order request base" ); }


    @Override public SecurityIDSource getSecurityIDSource() { throw new IllegalFieldAccess( "Getter for securityIDSource event Restated is a delegate field from order request base" ); }
    ...
    @Override public int getOrderQty() { throw new IllegalFieldAccess( "Getter for orderQty event Restated is a delegate field from order request base" ); }


    @Override public double getPrice() { throw new IllegalFieldAccess( "Getter for price event Restated is a delegate field from order request base" ); }
    ...
    @Override public ViewString getOnBehalfOfId() { throw new IllegalFieldAccess( "Getter for onBehalfOfId event Restated is a delegate field from order request base" ); }
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.MarketRestated;
    }

    @Override
    public final MarketRestatedImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( MarketRestatedImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( ReusableString out ) {
        out.append( "MarketRestatedImpl" ).append( ' ' );
        out.append( ", execRestatementReason=" ).append( getExecRestatementReason() );
