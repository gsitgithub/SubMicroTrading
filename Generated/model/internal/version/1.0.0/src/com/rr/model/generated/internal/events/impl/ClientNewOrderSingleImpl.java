...
public final class ClientNewOrderSingleImpl implements OrderRequest, ClientNewOrderSingleWrite, Reusable<ClientNewOrderSingleImpl> {

   // Attrs

    private final ReusableString _buf = new ReusableString( SizeType.VIEW_NOS_BUFFER.getSize() );
    private          ClientNewOrderSingleImpl _next = null;
    private volatile Message        _nextMessage    = null;
    private          MessageHandler _messageHandler = null;
    private final ViewString _clOrdId = new ViewString( _buf );
    ...
    private final ViewString _origClOrdId = new ViewString( _buf );
   ...
   // Getters and Setters
    @Override public final ViewString getClOrdId() { return _clOrdId; }
              ...
              public final void setClOrdId( int offset, int len ) { _clOrdId.setValue( offset, len ); }
    @Override public final AssignableString getClOrdIdForUpdate() { return _clOrdId; }
    ...
    @Override public final ViewString getOrigClOrdId() { return _origClOrdId; }
              ...
              public final void setOrigClOrdId( int offset, int len ) { _origClOrdId.setValue( offset, len ); }
    @Override public final AssignableString getOrigClOrdIdForUpdate() { return _origClOrdId; }
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.ClientNewOrderSingle;
    }

    @Override
    public final ClientNewOrderSingleImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( ClientNewOrderSingleImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( ReusableString out ) {
        out.append( "ClientNewOrderSingleImpl" ).append( ' ' );
