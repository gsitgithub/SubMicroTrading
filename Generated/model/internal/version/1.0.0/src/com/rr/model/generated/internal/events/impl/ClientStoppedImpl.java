...
public final class ClientStoppedImpl implements CommonExecRpt, ClientStoppedUpdate, Reusable<ClientStoppedImpl> {

   // Attrs

    private          ClientStoppedImpl _next = null;
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.ClientStopped;
    }

    @Override
    public final ClientStoppedImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( ClientStoppedImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( ReusableString out ) {
        out.append( "ClientStoppedImpl" ).append( ' ' );
