...
public final class MarketForceCancelImpl implements MarketForceCancelUpdate, Reusable<MarketForceCancelImpl> {

   // Attrs

    private          MarketForceCancelImpl _next = null;
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.MarketForceCancel;
    }

    @Override
    public final MarketForceCancelImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( MarketForceCancelImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( ReusableString out ) {
        out.append( "MarketForceCancelImpl" ).append( ' ' );
