...
public final class RecoveryRejectedImpl implements CommonExecRpt, MarketRejectedWrite, Reusable<RecoveryRejectedImpl> {

   // Attrs

    private          RecoveryRejectedImpl _next = null;
   ...
   // Getters and Setters
    ...
    public final void setOrdRejReason( OrdRejReason val ) { _ordRejReason = val; }
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.RecoveryRejected;
    }

    @Override
    public final RecoveryRejectedImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( RecoveryRejectedImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( ReusableString out ) {
        out.append( "RecoveryRejectedImpl" ).append( ' ' );
