...
public final class ClientCancelledImpl implements CommonExecRpt, ClientCancelledUpdate, Reusable<ClientCancelledImpl> {

   // Attrs

    private          ClientCancelledImpl _next = null;
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.ClientCancelled;
    }

    @Override
    public final ClientCancelledImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( ClientCancelledImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( ReusableString out ) {
        out.append( "ClientCancelledImpl" ).append( ' ' );
