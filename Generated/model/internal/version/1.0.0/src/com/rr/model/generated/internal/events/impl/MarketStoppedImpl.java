...
public final class MarketStoppedImpl implements CommonExecRpt, MarketStoppedWrite, Reusable<MarketStoppedImpl> {

   // Attrs

    private          MarketStoppedImpl _next = null;
   ...
   // Getters and Setters
    ...
    @Override public ViewString getSecurityId() { throw new IllegalFieldAccess( "Getter for securityId event Stopped is a delegate field from order request base" ); }


    @Override public ViewString getSymbol() { throw new IllegalFieldAccess( "Getter for symbol event Stopped is a delegate field from order request base" ); }


    @Override public Currency getCurrency() { throw new IllegalFieldAccess( "Getter for currency event Stopped is a delegate field from order request base" ); }


    @Override public SecurityIDSource getSecurityIDSource() { throw new IllegalFieldAccess( "Getter for securityIDSource event Stopped is a delegate field from order request base" ); }
    ...
    @Override public int getOrderQty() { throw new IllegalFieldAccess( "Getter for orderQty event Stopped is a delegate field from order request base" ); }


    @Override public double getPrice() { throw new IllegalFieldAccess( "Getter for price event Stopped is a delegate field from order request base" ); }
    ...
    @Override public ViewString getOnBehalfOfId() { throw new IllegalFieldAccess( "Getter for onBehalfOfId event Stopped is a delegate field from order request base" ); }
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.MarketStopped;
    }

    @Override
    public final MarketStoppedImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( MarketStoppedImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( ReusableString out ) {
        out.append( "MarketStoppedImpl" ).append( ' ' );
