...
public final class ClientSuspendedImpl implements CommonExecRpt, ClientSuspendedUpdate, Reusable<ClientSuspendedImpl> {

   // Attrs

    private          ClientSuspendedImpl _next = null;
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.ClientSuspended;
    }

    @Override
    public final ClientSuspendedImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( ClientSuspendedImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( ReusableString out ) {
        out.append( "ClientSuspendedImpl" ).append( ' ' );
