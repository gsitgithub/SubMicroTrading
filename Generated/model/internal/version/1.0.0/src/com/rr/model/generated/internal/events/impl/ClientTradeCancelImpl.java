...
public final class ClientTradeCancelImpl implements TradeBase, ClientTradeCancelUpdate, Reusable<ClientTradeCancelImpl> {

   // Attrs

    private          ClientTradeCancelImpl _next = null;
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.ClientTradeCancel;
    }

    @Override
    public final ClientTradeCancelImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( ClientTradeCancelImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( ReusableString out ) {
        out.append( "ClientTradeCancelImpl" ).append( ' ' );
