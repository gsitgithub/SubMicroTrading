...
public final class ETIUserLogoutResponseImpl implements BaseETIResponse, ETIUserLogoutResponseWrite, Reusable<ETIUserLogoutResponseImpl> {

   // Attrs

    private          ETIUserLogoutResponseImpl _next = null;
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.ETIUserLogoutResponse;
    }

    @Override
    public final ETIUserLogoutResponseImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( ETIUserLogoutResponseImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( ReusableString out ) {
        out.append( "ETIUserLogoutResponseImpl" ).append( ' ' );
