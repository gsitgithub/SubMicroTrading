...
public final class RecoveryCMEDecoder extends AbstractFixDecoder42 {
   ...
   // Constructors
    public RecoveryCMEDecoder() {
        this( FixVersion.Fix4_2._major, FixVersion.Fix4_2._minor );
    }

    public RecoveryCMEDecoder( byte major, byte minor ) {
        super( major, minor );
    }
