...
public final class Standard44Encoder implements FixEncoder {
   ...
   // Constructors
    public Standard44Encoder( byte[] buf, int offset ) {
        this( FixVersion.Fix4_4._major, FixVersion.Fix4_4._minor, buf, offset );
    }

    public Standard44Encoder( byte major, byte minor, byte[] buf, int offset ) {
    ...
    public Standard44Encoder( byte major, byte minor, byte[] buf ) {
   ...
   // encode methods
    ...
    public final void encodeNewOrderSingle( final NewOrderSingle msg ) {
        ...
        _builder.encodeInt( FixDictionary44.OrderQty, msg.getOrderQty() );        // tag38
        ...
        _builder.encodeString( FixDictionary44.SrcLinkId, msg.getSrcLinkId() );        // tag526
        ...
        _builder.encodeString( FixDictionary44.SecurityExchange, msg.getSecurityExchange() );        // tag207
    ...
    public final void encodeNewOrderAck( final NewOrderAck msg ) {
        ...
        _builder.encodeInt( FixDictionary44.CumQty, msg.getCumQty() );        // tag14
        _builder.encodeInt( FixDictionary44.LeavesQty, msg.getLeavesQty() );        // tag151
        _builder.encodeEnvelope();
    }
    ...
    public final void encodeTradeNew( final TradeNew msg ) {
        ...
        _builder.encodeInt( FixDictionary44.CumQty, msg.getCumQty() );        // tag14
        _builder.encodeInt( FixDictionary44.LeavesQty, msg.getLeavesQty() );        // tag151
        _builder.encodeInt( FixDictionary44.LastQty, msg.getLastQty() );        // tag32
