...
public final class Standard50Encoder implements FixEncoder {
   ...
   // Constructors
    public Standard50Encoder( byte[] buf, int offset ) {
        this( FixVersion.Fix5_0._major, FixVersion.Fix5_0._minor, buf, offset );
    }

    public Standard50Encoder( byte major, byte minor, byte[] buf, int offset ) {
    ...
    public Standard50Encoder( byte major, byte minor, byte[] buf ) {
   ...
   // encode methods
    ...
    public final void encodeNewOrderSingle( final NewOrderSingle msg ) {
        ...
        _builder.encodeByte( 35, MSG_NewOrderSingle );
            _builder.encodeString( FixDictionary50.SenderCompID, _senderCompId ); // tag49;
            _builder.encodeString( FixDictionary50.TargetCompID, _targetCompId ); // tag56;
        _builder.encodeInt( FixDictionary50.MsgSeqNum, msg.getMsgSeqNum() );        // tag34
            _builder.encodeString( FixDictionary50.SenderSubID, _senderSubId ); // tag50;
            _builder.encodeString( FixDictionary50.TargetSubID, _targetSubId ); // tag57;
        _builder.encodeBool( FixDictionary50.PossDupFlag, msg.getPossDupFlag() );        // tag43
        _builder.encodeUTCTimestamp( FixDictionary50.SendingTime, now );        // tag52
        _builder.encodeString( FixDictionary50.ClOrdId, msg.getClOrdId() );        // tag11
        final TimeInForce tTimeInForce = msg.getTimeInForce();
        if ( tTimeInForce != null ) _builder.encodeByte( FixDictionary50.TimeInForce, tTimeInForce.getVal() );        // tag59
        final SecurityIDSource tSecurityIDSource = msg.getSecurityIDSource();
        if ( tSecurityIDSource != null ) _builder.encodeByte( FixDictionary50.SecurityIDSource, tSecurityIDSource.getVal() );        // tag22
        _builder.encodeString( FixDictionary50.SecurityID, msg.getSecurityId() );        // tag48
        _builder.encodeInt( FixDictionary50.OrderQty, msg.getOrderQty() );        // tag38
        _builder.encodePrice( FixDictionary50.Price, msg.getPrice() );        // tag44
        final Currency tCurrency = msg.getCurrency();
        if ( tCurrency != null ) _builder.encodeBytes( FixDictionary50.Currency, tCurrency.getVal() );        // tag15
        _builder.encodeByte( FixDictionary50.OrdType, msg.getOrdType().getVal() );        // tag40
        _builder.encodeByte( FixDictionary50.Side, msg.getSide().getVal() );        // tag54
        _builder.encodeString( FixDictionary50.Symbol, msg.getSymbol() );        // tag55
        final HandlInst tHandlInst = msg.getHandlInst();
        if ( tHandlInst != null ) _builder.encodeByte( FixDictionary50.HandlInst, tHandlInst.getVal() );        // tag21
        _builder.encodeUTCTimestamp( FixDictionary50.TransactTime, now );        // tag60
        _builder.encodeString( FixDictionary50.ExDest, msg.getExDest() );        // tag100
        _builder.encodeString( FixDictionary50.Account, msg.getAccount() );        // tag1
        _builder.encodeString( FixDictionary50.SrcLinkId, msg.getSrcLinkId() );        // tag526
        final OrderCapacity tOrderCapacity = msg.getOrderCapacity();
        if ( tOrderCapacity != null ) _builder.encodeByte( FixDictionary50.OrderCapacity, tOrderCapacity.getVal() );        // tag528
        _builder.encodeString( FixDictionary50.Text, msg.getText() );        // tag58
        _builder.encodeString( FixDictionary50.SecurityExchange, msg.getSecurityExchange() );        // tag207
        final BookingType tBookingType = msg.getBookingType();
        if ( tBookingType != null ) _builder.encodeByte( FixDictionary50.BookingType, tBookingType.getVal() );        // tag775
    ...
    public final void encodeCancelReplaceRequest( final CancelReplaceRequest msg ) {
        ...
        _builder.encodeUTCTimestamp( FixDictionary50.SendingTime, now );        // tag52
        _builder.encodeString( FixDictionary50.ClOrdId, msg.getClOrdId() );        // tag11
        _builder.encodeString( FixDictionary50.OrigClOrdId, msg.getOrigClOrdId() );        // tag41
        _builder.encodeString( FixDictionary50.OrderId, msg.getOrderId() );        // tag37
        final TimeInForce tTimeInForce = msg.getTimeInForce();
        if ( tTimeInForce != null ) _builder.encodeByte( FixDictionary50.TimeInForce, tTimeInForce.getVal() );        // tag59
        final SecurityIDSource tSecurityIDSource = msg.getSecurityIDSource();
        if ( tSecurityIDSource != null ) _builder.encodeByte( FixDictionary50.SecurityIDSource, tSecurityIDSource.getVal() );        // tag22
    ...
    public final void encodeCancelReject( final CancelReject msg ) {
        ...
        _builder.encodeString( FixDictionary50.ClOrdId, msg.getClOrdId() );        // tag11
        _builder.encodeString( FixDictionary50.OrigClOrdId, msg.getOrigClOrdId() );        // tag41
        _builder.encodeByte( FixDictionary50.OrdStatus, msg.getOrdStatus().getVal() );        // tag39
        final CxlRejReason tCxlRejReason = msg.getCxlRejReason();
        if ( tCxlRejReason != null ) _builder.encodeBytes( FixDictionary50.CxlRejReason, tCxlRejReason.getVal() );        // tag102
        _builder.encodeByte( FixDictionary50.CxlRejResponseTo, msg.getCxlRejResponseTo().getVal() );        // tag434
        _builder.encodeString( FixDictionary50.Text, msg.getText() );        // tag58
        _builder.encodeEnvelope();
    }
    ...
    public final void encodeNewOrderAck( final NewOrderAck msg ) {
        ...
        _builder.encodeUTCTimestamp( FixDictionary50.SendingTime, now );        // tag52
        _builder.encodeString( FixDictionary50.ClOrdId, msg.getClOrdId() );        // tag11
        _builder.encodeString( FixDictionary50.ExecID, msg.getExecId() );        // tag17
        _builder.encodeString( FixDictionary50.OrderId, msg.getOrderId() );        // tag37
        _builder.encodeByte( FixDictionary50.OrdStatus, msg.getOrdStatus().getVal() );        // tag39
        _builder.encodeByte( FixDictionary50.ExecType, msg.getExecType().getVal() );        // tag150
        _builder.encodeInt( FixDictionary50.OrderQty, msg.getOrderQty() );        // tag38
        _builder.encodePrice( FixDictionary50.Price, msg.getPrice() );        // tag44
        _builder.encodeByte( FixDictionary50.Side, msg.getSide().getVal() );        // tag54
        _builder.encodeString( FixDictionary50.Symbol, msg.getSymbol() );        // tag55
        ...
        if ( tSecurityIDSource != null ) _builder.encodeByte( FixDictionary50.SecurityIDSource, tSecurityIDSource.getVal() );        // tag22
        _builder.encodeString( FixDictionary50.SecurityID, msg.getSecurityId() );        // tag48
        _builder.encodePrice( FixDictionary50.AvgPx, msg.getAvgPx() );        // tag6
        _builder.encodeInt( FixDictionary50.CumQty, msg.getCumQty() );        // tag14
        _builder.encodeInt( FixDictionary50.LeavesQty, msg.getLeavesQty() );        // tag151
        _builder.encodeEnvelope();
    }
    ...
    public final void encodeTradeNew( final TradeNew msg ) {
        ...
        _builder.encodeInt( FixDictionary50.CumQty, msg.getCumQty() );        // tag14
        _builder.encodeInt( FixDictionary50.LeavesQty, msg.getLeavesQty() );        // tag151
        _builder.encodeInt( FixDictionary50.LastQty, msg.getLastQty() );        // tag32
        _builder.encodePrice( FixDictionary50.LastPx, msg.getLastPx() );        // tag31
        _builder.encodeString( FixDictionary50.LastMkt, msg.getLastMkt() );        // tag30
        _builder.encodeString( FixDictionary50.SecurityDesc, msg.getSecurityDesc() );        // tag107
        final MultiLegReportingType tMultiLegReportingType = msg.getMultiLegReportingType();
        if ( tMultiLegReportingType != null ) _builder.encodeByte( FixDictionary50.MultiLegReportingType, tMultiLegReportingType.getVal() );        // tag442
        _builder.encodeEnvelope();
    }
    ...
    public final void encodeRestated( final Restated msg ) {
        ...
        if ( tExecRestatementReason != null ) _builder.encodeTwoByte( FixDictionary50.ExecRestatementReason, tExecRestatementReason.getVal() );        // tag378
        _builder.encodeEnvelope();
    }
    ...
    public final void encodeTradeCorrect( final TradeCorrect msg ) {
        ...
        final MultiLegReportingType tMultiLegReportingType = msg.getMultiLegReportingType();
        if ( tMultiLegReportingType != null ) _builder.encodeByte( FixDictionary50.MultiLegReportingType, tMultiLegReportingType.getVal() );        // tag442
        _builder.encodeString( FixDictionary50.ExecRefID, msg.getExecRefID() );        // tag19
        _builder.encodeEnvelope();
    }
    ...
    public final void encodeHeartbeat( final Heartbeat msg ) {
        ...
        _builder.encodeBool( FixDictionary50.PossDupFlag, msg.getPossDupFlag() );        // tag43
        _builder.encodeUTCTimestamp( FixDictionary50.SendingTime, now );        // tag52
        _builder.encodeString( FixDictionary50.testReqID, msg.getTestReqID() );        // tag112
        _builder.encodeEnvelope();
    }
    ...
    public final void encodeLogon( final Logon msg ) {
        ...
        _builder.encodeString( FixDictionary50.SenderCompID, msg.getSenderCompId() );        // tag49
        _builder.encodeString( FixDictionary50.TargetCompID, msg.getTargetCompId() );        // tag56
        _builder.encodeInt( FixDictionary50.MsgSeqNum, msg.getMsgSeqNum() );        // tag34
        _builder.encodeString( FixDictionary50.SenderSubID, msg.getSenderSubId() );        // tag50
        _builder.encodeString( FixDictionary50.TargetSubID, msg.getTargetSubId() );        // tag57
        _builder.encodeBool( FixDictionary50.PossDupFlag, msg.getPossDupFlag() );        // tag43
        _builder.encodeUTCTimestamp( FixDictionary50.SendingTime, now );        // tag52
        final EncryptMethod tEncryptMethod = msg.getEncryptMethod();
        if ( tEncryptMethod != null ) _builder.encodeByte( FixDictionary50.EncryptMethod, tEncryptMethod.getVal() );        // tag98
        _builder.encodeInt( FixDictionary50.heartBtInt, msg.getHeartBtInt() );        // tag108
        _builder.encodeInt( FixDictionary50.RawDataLen, msg.getRawDataLen() );        // tag95
        _builder.encodeString( FixDictionary50.RawData, msg.getRawData() );        // tag96
        _builder.encodeBool( FixDictionary50.ResetSeqNumFlag, msg.getResetSeqNumFlag() );        // tag141
        _builder.encodeInt( FixDictionary50.NextExpectedMsgSeqNum, msg.getNextExpectedMsgSeqNum() );        // tag789
        _builder.encodeEnvelope();
    }
    ...
    public final void encodeLogout( final Logout msg ) {
        ...
        _builder.encodeUTCTimestamp( FixDictionary50.SendingTime, now );        // tag52
        _builder.encodeString( FixDictionary50.Text, msg.getText() );        // tag58
        _builder.encodeInt( FixDictionary50.lastMsgSeqNumProcessed, msg.getLastMsgSeqNumProcessed() );        // tag369
        _builder.encodeInt( FixDictionary50.NextExpectedMsgSeqNum, msg.getNextExpectedMsgSeqNum() );        // tag789
        _builder.encodeEnvelope();
    }
    ...
    public final void encodeSessionReject( final SessionReject msg ) {
        ...
        _builder.encodeBool( FixDictionary50.PossDupFlag, msg.getPossDupFlag() );        // tag43
        _builder.encodeUTCTimestamp( FixDictionary50.SendingTime, now );        // tag52
        _builder.encodeInt( FixDictionary50.RefSeqNum, msg.getRefSeqNum() );        // tag45
        _builder.encodeInt( FixDictionary50.RefTagID, msg.getRefTagID() );        // tag371
        _builder.encodeString( FixDictionary50.RefMsgType, msg.getRefMsgType() );        // tag372
        final SessionRejectReason tSessionRejectReason = msg.getSessionRejectReason();
        if ( tSessionRejectReason != null ) _builder.encodeTwoByte( FixDictionary50.SessionRejectReason, tSessionRejectReason.getVal() );        // tag373
        _builder.encodeString( FixDictionary50.Text, msg.getText() );        // tag58
        _builder.encodeEnvelope();
    }
    ...
    public final void encodeResendRequest( final ResendRequest msg ) {
        ...
        _builder.encodeBool( FixDictionary50.PossDupFlag, msg.getPossDupFlag() );        // tag43
        _builder.encodeUTCTimestamp( FixDictionary50.SendingTime, now );        // tag52
        _builder.encodeInt( FixDictionary50.BeginSeqNo, msg.getBeginSeqNo() );        // tag7
        _builder.encodeInt( FixDictionary50.EndSeqNo, msg.getEndSeqNo() );        // tag16
        _builder.encodeEnvelope();
    }
    ...
    public final void encodeSequenceReset( final SequenceReset msg ) {
        ...
        _builder.encodeBool( FixDictionary50.PossDupFlag, msg.getPossDupFlag() );        // tag43
        _builder.encodeUTCTimestamp( FixDictionary50.SendingTime, now );        // tag52
        _builder.encodeBool( FixDictionary50.GapFillFlag, msg.getGapFillFlag() );        // tag123
        _builder.encodeInt( FixDictionary50.NewSeqNo, msg.getNewSeqNo() );        // tag36
        _builder.encodeEnvelope();
    }
