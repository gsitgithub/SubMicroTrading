...
public final class RecoveryStandard42Decoder extends AbstractFixDecoder42 {
   ...
   // Constructors
    public RecoveryStandard42Decoder() {
        this( FixVersion.Fix4_2._major, FixVersion.Fix4_2._minor );
    }

    public RecoveryStandard42Decoder( byte major, byte minor ) {
        super( major, minor );
    }
