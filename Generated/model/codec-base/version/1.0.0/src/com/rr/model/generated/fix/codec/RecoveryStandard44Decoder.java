...
public final class RecoveryStandard44Decoder extends AbstractFixDecoder44 {
   ...
   // Constructors
    public RecoveryStandard44Decoder() {
        this( FixVersion.Fix4_4._major, FixVersion.Fix4_4._minor );
    }

    public RecoveryStandard44Decoder( byte major, byte minor ) {
        super( major, minor );
    }
