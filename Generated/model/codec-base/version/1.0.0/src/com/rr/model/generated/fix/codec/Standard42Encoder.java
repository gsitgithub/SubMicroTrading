...
public final class Standard42Encoder implements FixEncoder {
   ...
   // Constructors
    public Standard42Encoder( byte[] buf, int offset ) {
        this( FixVersion.Fix4_2._major, FixVersion.Fix4_2._minor, buf, offset );
    }

    public Standard42Encoder( byte major, byte minor, byte[] buf, int offset ) {
    ...
    public Standard42Encoder( byte major, byte minor, byte[] buf ) {
