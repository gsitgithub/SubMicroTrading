...
public final class MD50Encoder implements FixEncoder {
   ...
   // Constructors
    public MD50Encoder( byte[] buf, int offset ) {
        this( FixVersion.MDFix5_0._major, FixVersion.MDFix5_0._minor, buf, offset );
    }

    public MD50Encoder( byte major, byte minor, byte[] buf, int offset ) {
    ...
    public MD50Encoder( byte major, byte minor, byte[] buf ) {
   ...
   // encode methods
    ...
    public final void encodeMDRequest( final MDRequest msg ) {
        ...
        _builder.encodeInt( FixDictionaryMD50.numRelatedSym, msg.getNumRelatedSym() );        // tag146
        _builder.encodeEnvelope();
    }
    ...
    public final void encodeSecurityStatus( final SecurityStatus msg ) {
        ...
        _builder.encodeLong( FixDictionaryMD50.securityID, msg.getSecurityID() );        // tag48
    ...
    public final void encodeSecurityDefinition( final SecurityDefinition msg ) {
        ...
        _builder.encodeInt( FixDictionaryMD50.noEvents, msg.getNoEvents() );        // tag864
        ...
        _builder.encodeInt( FixDictionaryMD50.noLegs, msg.getNoLegs() );        // tag555
        ...
        _builder.encodeString( FixDictionaryMD50.underlyingProduct, msg.getUnderlyingProduct() );        // tag462
        _builder.encodeString( FixDictionaryMD50.securityExchange, msg.getSecurityExchange() );        // tag207
        _builder.encodeInt( FixDictionaryMD50.noSecurityAltID, msg.getNoSecurityAltID() );        // tag454
        ...
        _builder.encodeInt( FixDictionaryMD50.noSDFeedTypes, msg.getNoSDFeedTypes() );        // tag1141
        _builder.encodeLong( FixDictionaryMD50.maturityMonthYear, msg.getMaturityMonthYear() );        // tag200
        _builder.encodeLong( FixDictionaryMD50.lastUpdateTime, msg.getLastUpdateTime() );        // tag779
        ...
        _builder.encodeInt( FixDictionaryMD50.contractMultiplier, msg.getContractMultiplier() );        // tag231
