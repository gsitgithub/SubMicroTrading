...
public final class ETIBSEEncoder implements com.rr.codec.emea.exchange.eti.ETIEncoder {
   ...
   // Member Vars
    ...
    private static final int      MSG_NewOrderRequest = 10100;
    private static final int      MSG_ReplaceOrderSingleRequest = 10106;
    private static final int      MSG_NewOrderStandardResponse = 10101;
    private static final int      MSG_ReplaceOrderStandardResponse = 10107;
    private static final int      MSG_CancelOrderStandardResponse = 10110;
    private static final int      MSG_NewOrderRequestMultiLeg = 10113;
    private static final int      MSG_ReplaceOrderMultiLeg = 10114;
    private static final int      MSG_CancelOrderMultiLeg = 10123;
   ...
   // encode methods
    ...
    public final void encode( final Message msg ) {
        ...
        case EventIds.ID_CANCELREQUEST:
            encodeCancel( (CancelRequest) msg );
            break;
    ...
    public final void encodeNewOrderSingle( final NewOrderSingle msg ) {
        ...
        _builder.encodePrice( Constants.UNSET_DOUBLE );    // stopPx
        if ( _debug ) _dump.append( "\nHook : " ).append( "maxPricePercentage" ).append( " : " ).append( "encode" ).append( " : " );
        _builder.encodePrice( 0.5 );
        if ( _debug ) _dump.append( "\nHook : " ).append( "senderLocationID" ).append( " : " ).append( "encode" ).append( " : " );
        _builder.encodeLong( _locationId );
        if ( _debug ) _dump.append( "\nField: " ).append( "clOrdId" ).append( " : " );
        _builder.encodeStringAsLong( msg.getClOrdId() );
        ...
        _builder.encodeUInt( Constants.UNSET_INT );    // expireDate
        if ( _debug ) _dump.append( "\nHook : " ).append( "marketSegmentID" ).append( " : " ).append( "encode" ).append( " : " );
        encodeMarketSegmentID( msg.getInstrument() );
        if ( _debug ) _dump.append( "\nHook : " ).append( "simpleSecurityID" ).append( " : " ).append( "encode" ).append( " : " );
        encodeSimpleSecurityId( msg.getInstrument() );
        ...
        _builder.encodeFiller( 3 );
        if ( _debug ) _dump.append( "\nField: " ).append( "filler4" ).append( " : " );
        _builder.encodeFiller( 9 );
        if ( _debug ) _dump.append( "\nHook : " ).append( "accountType" ).append( " : " ).append( "encode" ).append( " : " );
        _builder.encodeByte( (byte)20 );
        if ( _debug ) _dump.append( "\nHook : " ).append( "applSeqIndicator" ).append( " : " ).append( "encode" ).append( " : " );
        _builder.encodeByte( (byte)0 );
        if ( _debug ) _dump.append( "\nField: " ).append( "side" ).append( " : " );
        _builder.encodeByte( transformSide( msg.getSide() ) );
        ...
        _builder.encodeUByte( Constants.UNSET_BYTE );    // tradingSessionSubID
        if ( _debug ) _dump.append( "\nHook : " ).append( "orderCapacity" ).append( " : " ).append( "encode" ).append( " : " );
        _builder.encodeByte( (byte)1 );
        if ( _debug ) _dump.append( "\nHook : " ).append( "account" ).append( " : " ).append( "encode" ).append( " : " );
        _builder.encodeStringFixedWidth( _account, 2 );
        if ( _debug ) _dump.append( "\nHook : " ).append( "positionEffect" ).append( " : " ).append( "encode" ).append( " : " );
    ...
    public final void encodeNewOrderSingleMultiLeg( final NewOrderSingle msg ) {
        ...
        if ( _debug ) _dump.append( "\nField: " ).append( "clOrdId" ).append( " : " );
        _builder.encodeStringAsLong( msg.getClOrdId() );
        if ( _debug ) _dump.append( "\nHook : " ).append( "securityId" ).append( " : " ).append( "encode" ).append( " : " );
        encodeSecurityId( msg.getInstrument() );
        if ( _debug ) _dump.append( "\nHook : " ).append( "maxPricePercentage" ).append( " : " ).append( "encode" ).append( " : " );
        _builder.encodePrice( 0.5 );
        if ( _debug ) _dump.append( "\nHook : " ).append( "senderLocationID" ).append( " : " ).append( "encode" ).append( " : " );
        _builder.encodeLong( _locationId );
