...
public final class ETIBSEDecoder extends AbstractBinaryDecoder implements com.rr.codec.emea.exchange.eti.ETIDecoder {
   ...
   // Attrs
    ...
    private static final short      MSG_NewOrderRequestSimple = 10125;
    private static final short      MSG_ReplaceOrderSingleShortRequest = 10126;
    private static final short      MSG_NewOrderLeanResponse = 10102;
    private static final short      MSG_ReplaceOrderLeanResponse = 10108;
    private static final short      MSG_CancelOrderLeanResponse = 10111;
    ...
    private static final short      MSG_NewOrderRequestMultiLeg = 10113;
    private static final short      MSG_ReplaceOrderMultiLeg = 10114;
    private static final short      MSG_CancelOrderMultiLeg = 10123;
    ...
    private       double                      _priceMkToLimitPx;
   ...
   // decode methods
    ...
    protected final Message doMessageDecode() {
        ...
        case MSG_Reject:
            return decodeReject();
        case MSG_NewOrderRequestSimple:
            return decodeNewOrderRequestSimple();
        case MSG_ReplaceOrderSingleShortRequest:
            return decodeReplaceOrderSingleShortRequest();
        case MSG_NewOrderLeanResponse:
            return decodeNewOrderLeanResponse();
        case MSG_ReplaceOrderLeanResponse:
            return decodeReplaceOrderLeanResponse();
        case MSG_CancelOrderLeanResponse:
            return decodeCancelOrderLeanResponse();
        ...
        case MSG_NewOrderRequestMultiLeg:
            return decodeNewOrderRequestMultiLeg();
        case MSG_ReplaceOrderMultiLeg:
            return decodeReplaceOrderMultiLeg();
        case MSG_CancelOrderMultiLeg:
            return decodeCancelOrderMultiLeg();
        case 10004:
        case 10013:
        case 10014:
        case 10015:
    ...
    private final Message decodeNewOrderRequestSimple() {
        ...
        _builder.skip( 4 );
        _securityId = _builder.decodeUInt();
        if ( _debug ) _dump.append( "\nField: " ).append( "accountType" ).append( " : " );
        _accountType = _builder.decodeUByte();
        ...
        if ( _debug ) _dump.append( "\nField: " ).append( "filler3" ).append( " : " );
        _builder.skip( 3 );    // pad3
        if ( _debug ) _dump.append( "\nHook : " ).append( "postdecode" ).append( " : " );
        enrich( msg ) ; msg.setOrdType( OrdType.Limit );
        _builder.end();
        return msg;
    }
    ...
    private final Message conditionalDecoder1( Message prevMsg ) {
        ...
        case '0': {
                ...
                msg.getClOrdIdForUpdate().append( _clOrdId );
                msg.getSecurityIdForUpdate().append( _securityId );
                msg.setPrice( _priceMkToLimitPx );
        ...
        case 49: case 50: case 51: case 53: case 54: case 55: case 56: 
            break;
        }
    ...
    private final Message decodeNewOrderLeanResponse() {
        ...
        _priceMkToLimitPx = _builder.decodePrice();
        if ( _debug ) _dump.append( "\nField: " ).append( "execId" ).append( " : " );
    ...
    private final Message decodeNewOrderRequestMultiLeg() {
        ...
        if ( _debug ) _dump.append( "\nField: " ).append( "clOrdId" ).append( " : " );
        _builder.decodeLongToString( msg.getClOrdIdForUpdate() );
        _securityId = _builder.decodeULong();
        if ( _debug ) _dump.append( "\nField: " ).append( "maxPricePercentage" ).append( " : " );
        _maxPricePercentage = _builder.decodePrice();
        if ( _debug ) _dump.append( "\nField: " ).append( "senderLocationID" ).append( " : " );
        _senderLocationID = _builder.decodeULong();
