...
public final class ETIEurexLFTEncoder implements com.rr.codec.emea.exchange.eti.ETIEncoder {
   ...
   // Constructors
    public ETIEurexLFTEncoder( byte[] buf, int offset ) {
   ...
   // encode methods
    ...
    public final void encode( final Message msg ) {
        ...
        case EventIds.ID_REPLACED:
            encodeReplaceResponse( (Replaced) msg );
            break;
        case 4:
        case 5:
        case 6:
    ...
    public final void encodeNewOrder( final NewOrderSingle msg ) {
        ...
        _builder.encodePrice( Constants.UNSET_DOUBLE );    // maxPricePercentage
        if ( _debug ) _dump.append( "\nField: " ).append( "senderLocationID" ).append( " : " );
        _builder.encodeULong( Constants.UNSET_LONG );    // senderLocationID
        if ( _debug ) _dump.append( "\nField: " ).append( "clOrdId" ).append( " : " );
        _builder.encodeStringAsLong( msg.getClOrdId() );
        ...
        if ( _debug ) _dump.append( "\nField: " ).append( "account" ).append( " : " );
        _builder.encodeZStringFixedWidth( msg.getAccount(), 2 );
        if ( _debug ) _dump.append( "\nHook : " ).append( "positionEffect" ).append( " : " ).append( "encode" ).append( " : " );
        _builder.encodeChar( (byte)'C' );
        if ( _debug ) _dump.append( "\nField: " ).append( "filler5" ).append( " : " );
    ...
    public final void encodeReplaceResponse( final Replaced msg ) {
        final int now = _tzCalculator.getNowUTC();
    ...
    public final void encodeOrderReplaceCancelled( final Cancelled msg ) {
        final int now = _tzCalculator.getNowUTC();
        _builder.start( MSG_ReplaceOrderStandardResponse );
        if ( _debug ) {
