...
/**
 * message queue consumer, single producer single consumer
 */
public final class RingBufferMsgQueue1C1P implements MessageQueue {
    ...
    private          long       _lastClaimedByProducer  = NOT_SET;
    
    private          long       _unsafeProducerLastSeenConsumed; // helps avoid spinning read barrier
    
    private final String    _id;

    public RingBufferMsgQueue1C1P( int size ) {
        this( null, size );
    }
    
    public RingBufferMsgQueue1C1P( String id, int size ) {
    ...
    @Override
    public int size() {
        return (int) (_lastClaimedByProducer - _unsafeLastConsumed);
    }
    ...
    public void clear() {
        ...
        _lastClaimedByProducer = NOT_SET;
    }
    ...
    private long waitForNextFreeEntry() {
        final long sequenceForPut = ++_lastClaimedByProducer;
