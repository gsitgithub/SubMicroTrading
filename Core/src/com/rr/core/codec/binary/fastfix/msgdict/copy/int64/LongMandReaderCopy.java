...
public final class LongMandReaderCopy extends CopyFieldReader implements FixFieldReader<LongFieldValWrapper> {
    ...
    public LongMandReaderCopy( String name, int id, String init ) {
        this( name, id, FieldUtils.parseLong(init) );
    }
    
    public LongMandReaderCopy( String name, int id ) {
        this( name, id, Constants.UNSET_LONG );
    }
    
    public LongMandReaderCopy( String name, int id, long init ) {
        super( name, id, false );
        _init = init;
        reset();
    }
