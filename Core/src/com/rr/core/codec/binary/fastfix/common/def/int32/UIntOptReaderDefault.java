...
public final class UIntOptReaderDefault extends DefaultFieldReader implements FixFieldReader<IntFieldValWrapper> {

    private final int _init;
    
    public UIntOptReaderDefault( String name, int id, String init ) {
        this( name, id, FieldUtils.parseInt(init) );
    }

    public UIntOptReaderDefault( String name, int id ) {
        this( name, id, Constants.UNSET_INT );
    }

    public UIntOptReaderDefault( String name, int id, int init ) {
        super( name, id, true );
        _init = init;
        reset();
    }
