 ...
 *******************************************************************************/
package com.rr.core.codec.binary.fastfix.fulldict.custom.defexp.noopmant;
 ...
 * @author Richard Rose
 */
public class OptDefExpNoOpMantDecimalReader extends CustomDecimalFieldReader {

    private final int  _initExp;
    
    private final FastFixDecimal _prevDecimal = new FastFixDecimal();

    private final IntOptReaderDefault  _exp;
    private final LongMandReaderNoOp   _mant;
    
    public OptDefExpNoOpMantDecimalReader( ComponentFactory cf, String name, int id, String initExp, String initMant ) {
        this( cf, name, id, FieldUtils.parseInt(initExp) );
    }
    
    @SuppressWarnings( "boxing" )
    public OptDefExpNoOpMantDecimalReader( ComponentFactory cf, String name, int id, int initExp ) {
        super( name, id, true );
        
        _exp  = cf.getReader( IntOptReaderDefault.class, name + "Exp",  id, initExp );
