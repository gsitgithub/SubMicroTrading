...
public final class IntMandWriterNoOp extends NoOpFieldWriter {

    public IntMandWriterNoOp( String name, int id, String init ) {
        this( name, id );
    }
    
    public IntMandWriterNoOp( String name, int id ) {
        super( name, id, false );
        reset();
    }
