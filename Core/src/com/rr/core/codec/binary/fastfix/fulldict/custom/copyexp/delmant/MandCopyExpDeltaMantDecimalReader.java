 ...
 *******************************************************************************/
package com.rr.core.codec.binary.fastfix.fulldict.custom.copyexp.delmant;
 ...
 * @author Richard Rose
 */
public class MandCopyExpDeltaMantDecimalReader extends CustomDecimalFieldReader {
    ...
    private final IntMandReaderCopy  _exp;
    private final LongMandReaderDelta   _mant;
    
    public MandCopyExpDeltaMantDecimalReader( ComponentFactory cf, String name, int id, String initExp, String initMant ) {
        this( cf, name, id, FieldUtils.parseInt(initExp), FieldUtils.parseLong(initMant) );
    }
    
    @SuppressWarnings( "boxing" )
    public MandCopyExpDeltaMantDecimalReader( ComponentFactory cf, String name, int id, int initExp, long initMant ) {
        super( name, id, false );
        ...
        _exp  = cf.getReader( IntMandReaderCopy.class,    expName,  id, prevExp );
