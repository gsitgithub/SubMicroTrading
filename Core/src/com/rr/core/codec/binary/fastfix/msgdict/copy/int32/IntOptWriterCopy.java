...
public final class IntOptWriterCopy extends CopyFieldWriter {

    private final int _init;
    private       int _previous;
    
    public IntOptWriterCopy( String name, int id, String init ) {
        this( name, id, FieldUtils.parseInt(init) );
    }
    
    public IntOptWriterCopy( String name, int id ) {
        this( name, id, Constants.UNSET_INT );
    }
    
    public IntOptWriterCopy( String name, int id, int init ) {
        super( name, id, true );
        _init = init;
        reset();
    }
