...
public final class ULongOptWriterNoOp extends NoOpFieldWriter {

    public ULongOptWriterNoOp( String name, int id, String init ) {
        this( name, id );
    }
    
    public ULongOptWriterNoOp( String name, int id ) {
        super( name, id, true );
        reset();
    }
