...
public final class IntMandWriterDefault extends DefaultFieldWriter {

    private final int _init;
    
    public IntMandWriterDefault( String name, int id, String init ) {
        this( name, id, FieldUtils.parseInt(init) );
    }

    public IntMandWriterDefault( String name, int id ) {
        this( name, id, Constants.UNSET_INT );
    }

    public IntMandWriterDefault( String name, int id, int init ) {
        super( name, id, false );
        _init = init;
        reset();
    }
