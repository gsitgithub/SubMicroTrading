...
public final class UIntMandWriterConst extends ConstantFieldWriter {

    private final int _constVal;
    
    public UIntMandWriterConst( String name, int id, String init ) {
        this( name, id, FieldUtils.parseInt(init) );
    }

    public UIntMandWriterConst( String name, int id, int init ) {
        super( name, id, false );
        _constVal = init;
    }
