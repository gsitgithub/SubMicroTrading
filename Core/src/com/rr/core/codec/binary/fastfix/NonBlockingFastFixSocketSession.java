 ...
 */
public abstract class NonBlockingFastFixSocketSession extends AbstractSocketSession implements NonBlockingSession {

    protected static final Logger _log = LoggerFactory.create( NonBlockingFastFixSocketSession.class );
    ...
    public NonBlockingFastFixSocketSession(  String                          name, 
