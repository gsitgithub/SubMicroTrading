 ...
 *******************************************************************************/
package com.rr.core.codec.binary.fastfix.msgdict.custom.copyexp.delmant;
 ...
 * @author Richard Rose
 */
public class MandCopyExpDeltaMantDecimalWriter extends CustomDecimalFieldWriter {
    ...
    private final IntMandWriterCopy  _exp;
    private final LongMandWriterDelta   _mant;
    
    public MandCopyExpDeltaMantDecimalWriter( ComponentFactory cf, String name, int id, String initExp, String initMant ) {
        this( cf, name, id, FieldUtils.parseInt(initExp), FieldUtils.parseLong(initMant) );
    }
    
    @SuppressWarnings( "boxing" )
    public MandCopyExpDeltaMantDecimalWriter( ComponentFactory cf, String name, int id, int initExp, long initMant ) {
        super( name, id, false );

        _exp  = cf.getWriter( IntMandWriterCopy.class, name + "Exp",  id, initExp );
