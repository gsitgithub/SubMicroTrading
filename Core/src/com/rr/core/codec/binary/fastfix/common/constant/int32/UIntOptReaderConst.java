...
public final class UIntOptReaderConst extends ConstantFieldReader implements FixFieldReader<IntFieldValWrapper> {

    private final int _constVal;
    
    public UIntOptReaderConst( String name, int id, String init ) {
        this( name, id, FieldUtils.parseInt(init) );
    }

    public UIntOptReaderConst( String name, int id, int init ) {
        super( name, id, true );
        _constVal = init;
    }
