...
public final class ULongOptReaderCopy extends CopyFieldReader implements FixFieldReader<LongFieldValWrapper> {

    private final long _init;
    private       long _previous;
    
    public ULongOptReaderCopy( String name, int id, String init ) {
        this( name, id, FieldUtils.parseLong(init) );
    }

    public ULongOptReaderCopy( String name, int id ) {
        this( name, id, Constants.UNSET_LONG );
    }
    
    public ULongOptReaderCopy( String name, int id, long init ) {
        super( name, id, true );
        _init = init;
        reset();
    }
