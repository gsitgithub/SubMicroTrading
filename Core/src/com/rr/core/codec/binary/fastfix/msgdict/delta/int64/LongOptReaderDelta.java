...
public final class LongOptReaderDelta extends DeltaFieldReader implements FixFieldReader<LongFieldValWrapper> {
    ...
    public LongOptReaderDelta( String name, int id, String init ) {
        this( name, id, FieldUtils.parseLong(init) );
    }

    public LongOptReaderDelta( String name, int id ) {
        this( name, id, 0 );
    }
    
    public LongOptReaderDelta( String name, int id, long init ) {
        super( name, id, true );
