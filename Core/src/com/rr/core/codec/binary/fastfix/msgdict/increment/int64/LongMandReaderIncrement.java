...
public final class LongMandReaderIncrement extends IncrementFieldReader implements FixFieldReader<LongFieldValWrapper> {
    ...
    public LongMandReaderIncrement( String name, int id, String init ) {
        this( name, id, FieldUtils.parseLong(init) );
    }
    
    public LongMandReaderIncrement( String name, int id ) {
        this( name, id, Constants.UNSET_LONG );
    }
    
    public LongMandReaderIncrement( String name, int id, long init ) {
        super( name, id, false );
