...
public final class LongOptWriterCopy extends CopyFieldWriter {

    private final long _init;
    private       long _previous;
    
    public LongOptWriterCopy( String name, int id, String init ) {
        this( name, id, FieldUtils.parseLong(init) );
    }
    
    public LongOptWriterCopy( String name, int id ) {
        this( name, id, Constants.UNSET_LONG );
    }
    
    public LongOptWriterCopy( String name, int id, long init ) {
        super( name, id, true );
        _init = init;
        reset();
    }
