...
public final class LongMandWriterNoOp extends NoOpFieldWriter {

    public LongMandWriterNoOp( String name, int id, String init ) {
        this( name, id );
    }
    
    public LongMandWriterNoOp( String name, int id ) {
        super( name, id, false );
        reset();
    }
