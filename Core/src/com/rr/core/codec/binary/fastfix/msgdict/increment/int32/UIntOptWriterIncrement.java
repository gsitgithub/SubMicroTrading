...
public final class UIntOptWriterIncrement extends IncrementFieldWriter {

    private final int _init;
    private       int _previous;
    
    public UIntOptWriterIncrement( String name, int id, String init ) {
        this( name, id, FieldUtils.parseInt(init) );
    }
    
    public UIntOptWriterIncrement( String name, int id ) {
        this( name, id, Constants.UNSET_INT );
    }
    
    public UIntOptWriterIncrement( String name, int id, int init ) {
        super( name, id, true );
        _init = init;
        reset();
    }
