 ...
 * @author Richard Rose
 */
public class OptCopyExpDeltaMantDecimalReader extends CustomDecimalFieldReader {
    ...
    private final IntOptReaderCopy  _exp;
    private final LongMandReaderDelta   _mant;
    
    public OptCopyExpDeltaMantDecimalReader( ComponentFactory cf, String name, int id, String initExp, String initMant ) {
        this( cf, name, id, FieldUtils.parseInt(initExp), FieldUtils.parseLong(initMant) );
    }
    
    @SuppressWarnings( "boxing" )
    public OptCopyExpDeltaMantDecimalReader( ComponentFactory cf, String name, int id, int initExp, long initMant ) {
        super( name, id, true );
        ...
        _exp  = cf.getReader( IntOptReaderCopy.class,     expName,  id, prevExp );
