...
public final class UIntOptWriterConst extends ConstantFieldWriter {

    private final int _constVal;
    
    public UIntOptWriterConst( String name, int id, String init ) {
        this( name, id, FieldUtils.parseInt(init) );
    }

    public UIntOptWriterConst( String name, int id, int init ) {
        super( name, id, true );
        _constVal = init;
    }
