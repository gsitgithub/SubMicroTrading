...
public final class ULongMandWriterIncrement extends IncrementFieldWriter {

    private final long _init;
    private       long _previous;
    
    public ULongMandWriterIncrement( String name, int id, String init ) {
        this( name, id, FieldUtils.parseLong(init) );
    }

    public ULongMandWriterIncrement( String name, int id ) {
        this( name, id, Constants.UNSET_LONG );
    }
    
    public ULongMandWriterIncrement( String name, int id, long init ) {
        super( name, id, false );
