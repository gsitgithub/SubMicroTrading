...
public final class DecimalMandWriterDefault extends DefaultFieldWriter {
    ...
    public DecimalMandWriterDefault( String name, int id, String init ) {
        this( name, id, FieldUtils.parseDouble(init) );
    }

    public DecimalMandWriterDefault( String name, int id, double init ) {
        super( name, id, false );
        _init = init;
        reset();
    }
