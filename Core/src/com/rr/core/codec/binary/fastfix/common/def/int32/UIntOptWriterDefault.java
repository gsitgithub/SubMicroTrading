...
public final class UIntOptWriterDefault extends DefaultFieldWriter {

    private final int _init;
    
    public UIntOptWriterDefault( String name, int id, String init ) {
        this( name, id, FieldUtils.parseInt(init) );
    }
    
    public UIntOptWriterDefault( String name, int id ) {
        this( name, id, Constants.UNSET_INT );
    }

    public UIntOptWriterDefault( String name, int id, int init ) {
        super( name, id, true );
        _init = init;
        reset();
    }
