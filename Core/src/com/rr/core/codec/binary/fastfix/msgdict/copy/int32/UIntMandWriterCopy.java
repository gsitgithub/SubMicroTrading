...
public final class UIntMandWriterCopy extends CopyFieldWriter {

    private final int _init;
    private       int _previous;
    
    public UIntMandWriterCopy( String name, int id, String init ) {
        this( name, id, FieldUtils.parseInt(init) );
    }
    
    public UIntMandWriterCopy( String name, int id ) {
        this( name, id, Constants.UNSET_INT );
    }
    
    public UIntMandWriterCopy( String name, int id, int init ) {
        super( name, id, false );
        _init = init;
        reset();
    }
