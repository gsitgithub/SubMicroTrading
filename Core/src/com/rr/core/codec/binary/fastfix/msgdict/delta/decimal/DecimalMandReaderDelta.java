...
public final class DecimalMandReaderDelta extends DeltaFieldReader implements FixFieldReader<DoubleFieldValWrapper> {
    ...
    public DecimalMandReaderDelta( String name, int id, String init ) {
        this( name, id, FieldUtils.parseDouble(init) );
    }

    public DecimalMandReaderDelta( String name, int id ) {
        this( name, id, 0 );
    }
    
    public DecimalMandReaderDelta( String name, int id, double init ) {
        super( name, id, false );
        _init = init;
        reset();
    }
