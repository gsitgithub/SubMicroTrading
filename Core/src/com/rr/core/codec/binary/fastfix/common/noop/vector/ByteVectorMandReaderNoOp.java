...
public final class ByteVectorMandReaderNoOp extends NoOpFieldReader implements FixFieldReader<StringFieldValWrapper> {

    public ByteVectorMandReaderNoOp( String name, int id, String init ) {
        this( name, id );
    }
    
    public ByteVectorMandReaderNoOp( String name, int id ) {
        super( name, id, false );
        reset();
    }
    ...
    public void read( final FastFixDecodeBuilder decoder, ReusableString dest ) {
        dest.reset();
        decoder.decodeMandByteVector( dest );
    }
