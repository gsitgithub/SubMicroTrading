...
public final class LongMandReaderDefault extends DefaultFieldReader implements FixFieldReader<LongFieldValWrapper> {

    private final long _init;
    
    public LongMandReaderDefault( String name, int id, String init ) {
        this( name, id, FieldUtils.parseLong(init) );
    }
    
    public LongMandReaderDefault( String name, int id ) {
        this( name, id, Constants.UNSET_LONG );
    }
    
    public LongMandReaderDefault( String name, int id, long init ) {
        super( name, id, false );
        _init = init;
        reset();
    }
