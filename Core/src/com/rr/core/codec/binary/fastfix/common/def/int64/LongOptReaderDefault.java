...
public final class LongOptReaderDefault extends DefaultFieldReader implements FixFieldReader<LongFieldValWrapper> {

    private final long _init;
    
    public LongOptReaderDefault( String name, int id, String init ) {
        this( name, id, FieldUtils.parseLong(init) );
    }

    public LongOptReaderDefault( String name, int id ) {
        this( name, id, Constants.UNSET_LONG );
    }
    
    public LongOptReaderDefault( String name, int id, long init ) {
        super( name, id, true );
        _init = init;
        reset();
    }
