...
public final class UIntMandReaderCopy extends CopyFieldReader implements FixFieldReader<IntFieldValWrapper> {

    private final int _init;
    private       int _previous;
    
    public UIntMandReaderCopy( String name, int id, String init ) {
        this( name, id, FieldUtils.parseInt(init) );
    }
    
    public UIntMandReaderCopy( String name, int id ) {
        this( name, id, Constants.UNSET_INT );
    }
    
    public UIntMandReaderCopy( String name, int id, int init ) {
        super( name, id, false );
        _init = init;
        reset();
    }
