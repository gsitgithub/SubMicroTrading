...
public final class UIntOptReaderCopy extends CopyFieldReader implements FixFieldReader<IntFieldValWrapper> {
    ...
    public UIntOptReaderCopy( String name, int id, String init ) {
        this( name, id, FieldUtils.parseInt(init) );
    }
    
    public UIntOptReaderCopy( String name, int id ) {
        this( name, id, Constants.UNSET_INT );
    }
    
    public UIntOptReaderCopy( String name, int id, int init ) {
        super( name, id, true );
        _init = init;
        reset();
    }
