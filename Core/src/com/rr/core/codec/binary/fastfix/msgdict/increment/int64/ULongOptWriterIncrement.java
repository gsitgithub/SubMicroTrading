...
public final class ULongOptWriterIncrement extends IncrementFieldWriter {

    private final long _init;
    private       long _previous;
    
    public ULongOptWriterIncrement( String name, int id, String init ) {
        this( name, id, FieldUtils.parseLong(init) );
    }

    public ULongOptWriterIncrement( String name, int id ) {
        this( name, id, Constants.UNSET_LONG );
    }
    
    public ULongOptWriterIncrement( String name, int id, long init ) {
        super( name, id, true );
