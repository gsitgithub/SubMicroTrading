...
public final class UIntMandReaderNoOp extends NoOpFieldReader implements FixFieldReader<IntFieldValWrapper> {

    public UIntMandReaderNoOp( String name, int id, String init ) {
        this( name, id );
    }
    
    public UIntMandReaderNoOp( String name, int id ) {
        super( name, id, false );
        reset();
    }
