...
public final class LongOptReaderNoOp extends NoOpFieldReader implements FixFieldReader<LongFieldValWrapper> {

    public LongOptReaderNoOp( String name, int id, String init ) {
        this( name, id );
    }
    
    public LongOptReaderNoOp( String name, int id ) {
        super( name, id, true );
        reset();
    }
    ...
    public long read( final FastFixDecodeBuilder decoder ) {
        ...
        return decoder.decodeOptionalLong();
    }
