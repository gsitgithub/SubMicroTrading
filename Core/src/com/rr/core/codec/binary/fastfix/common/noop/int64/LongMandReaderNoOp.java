...
public final class LongMandReaderNoOp extends NoOpFieldReader implements FixFieldReader<LongFieldValWrapper> {

    public LongMandReaderNoOp( String name, int id, String init ) {
        this( name, id );
    }
    
    public LongMandReaderNoOp( String name, int id ) {
        super( name, id, false );
        reset();
    }
