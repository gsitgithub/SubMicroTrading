...
public final class IntMandWriterIncrement extends IncrementFieldWriter {

    private final int _init;
    private       int _previous;
    
    public IntMandWriterIncrement( String name, int id, String init ) {
        this( name, id, FieldUtils.parseInt(init) );
    }

    public IntMandWriterIncrement( String name, int id ) {
        this( name, id, Constants.UNSET_INT );
    }
    
    public IntMandWriterIncrement( String name, int id, int init ) {
        super( name, id, false );
        _init = init;
        reset();
    }
