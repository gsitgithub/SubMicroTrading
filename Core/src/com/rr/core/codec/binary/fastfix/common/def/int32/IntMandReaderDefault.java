...
public final class IntMandReaderDefault extends DefaultFieldReader implements FixFieldReader<IntFieldValWrapper> {

    private final int _init;
    
    public IntMandReaderDefault( String name, int id, String init ) {
        this( name, id, FieldUtils.parseInt(init) );
    }
    
    public IntMandReaderDefault( String name, int id, int init ) {
        super( name, id, false );
        _init = init;
        reset();
    }
