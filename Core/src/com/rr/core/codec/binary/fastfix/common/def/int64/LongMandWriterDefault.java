...
public final class LongMandWriterDefault extends DefaultFieldWriter {

    private final long _init;
    
    public LongMandWriterDefault( String name, int id, String init ) {
        this( name, id, FieldUtils.parseLong(init) );
    }

    public LongMandWriterDefault( String name, int id ) {
        this( name, id, Constants.UNSET_LONG );
    }
    
    public LongMandWriterDefault( String name, int id, long init ) {
        super( name, id, false );
        _init = init;
        reset();
    }
