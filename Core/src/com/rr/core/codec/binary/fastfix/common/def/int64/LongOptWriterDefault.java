...
public final class LongOptWriterDefault extends DefaultFieldWriter {

    private final long _init;
    
    public LongOptWriterDefault( String name, int id, String init ) {
        this( name, id, FieldUtils.parseLong(init) );
    }

    public LongOptWriterDefault( String name, int id ) {
        this( name, id, Constants.UNSET_LONG );
    }
    
    public LongOptWriterDefault( String name, int id, long init ) {
        super( name, id, true );
        _init = init;
        reset();
    }
