...
public class IntMandFieldTest extends BaseTestCase {
    ...
    private IntMandReaderDefault      _fieldReader;
    private IntMandWriterDefault      _fieldWriter;
    ...
    public void setUp(){
        ...
        _fieldReader = new IntMandReaderDefault( "TestULong", 10018, 100 );
        _fieldWriter = new IntMandWriterDefault( "TestULong", 10018, 100 );
