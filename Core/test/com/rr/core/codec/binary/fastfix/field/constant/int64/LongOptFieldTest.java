...
public class LongOptFieldTest extends BaseTestCase {
    ...
    private LongOptReaderConst       _fieldReader;
    private LongOptWriterConst       _fieldWriter;
    ...
    private void checkField( long value ) {
        ...
        _fieldReader = new LongOptReaderConst( "TestULong", 10018, value );
        _fieldWriter = new LongOptWriterConst( "TestULong", 10018, value );
        
        _fieldWriter.write( _encoder, _mapWriter, value != Constants.UNSET_LONG );
        _mapWriter.end();
    ...
    private void write( long value ) {
        _fieldWriter = new LongOptWriterConst( "LongOptFieldTest", 10018, value );
