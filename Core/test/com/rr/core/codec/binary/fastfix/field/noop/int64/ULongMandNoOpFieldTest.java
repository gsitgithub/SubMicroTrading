...
public class ULongMandNoOpFieldTest extends BaseTestCase {
    ...
    private ULongMandReaderNoOp     _fieldReader;
    private ULongMandWriterNoOp     _fieldWriter;
    ...
    public void setUp(){
        ...
        _fieldReader = new ULongMandReaderNoOp( "TestULong", 10018 );
        _fieldWriter = new ULongMandWriterNoOp( "TestULong", 10018 );
