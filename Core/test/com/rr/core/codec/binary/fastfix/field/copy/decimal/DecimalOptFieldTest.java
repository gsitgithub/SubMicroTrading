 ...
 *******************************************************************************/
package com.rr.core.codec.binary.fastfix.field.copy.decimal;
...
public class DecimalOptFieldTest extends BaseTestCase {
    ...
    private DecimalOptReaderCopy       _fieldReader;
    private DecimalOptWriterCopy       _fieldWriter;
    ...
    public void setUp(){
        ...
        _fieldReader = new DecimalOptReaderCopy( "DecimalOptFieldTest", 10018 );
        _fieldWriter = new DecimalOptWriterCopy( "DecimalOptFieldTest", 10018 );
    ...
    public void testPrevCopy() {
        ...
        assertEquals( Constants.UNSET_DOUBLE, _fieldWriter.getPreviousValue(), Constants.WEIGHT );
