...
public class ULongOptIncFieldTest extends BaseTestCase {
    ...
    private ULongOptReaderIncrement  _fieldReader;
    private ULongOptWriterIncrement  _fieldWriter;
    ...
    public void setUp(){
        ...
        _fieldReader = new ULongOptReaderIncrement( "TestULong", 10018 );
        _fieldWriter = new ULongOptWriterIncrement( "TestULong", 10018 );
    ...
    public void testPrevCopy() {
        ...
        assertEquals( Constants.UNSET_LONG, _fieldWriter.getPreviousValue() );
        _fieldWriter.write( _encoder, _mapWriter, 100 );
        assertEquals( 100, _fieldWriter.getPreviousValue() );
        _mapWriter.end();
