...
public class UIntMandFieldTest extends BaseTestCase {
    ...
    private UIntMandReaderDefault     _fieldReader;
    private UIntMandWriterDefault     _fieldWriter;
    ...
    public void setUp(){
        ...
        _fieldReader = new UIntMandReaderDefault( "TestULong", 10018, 100 );
        _fieldWriter = new UIntMandWriterDefault( "TestULong", 10018, 100 );
