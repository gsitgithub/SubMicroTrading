...
public class DecimalMandFieldTest extends BaseTestCase {
    ...
    private DecimalMandReaderDefault      _fieldReader;
    private DecimalMandWriterDefault      _fieldWriter;
    ...
    public void setUp(){
        ...
        _fieldReader = new DecimalMandReaderDefault( "TestULong", 10018, 100.0 );
        _fieldWriter = new DecimalMandWriterDefault( "TestULong", 10018, 100.0 );
    ...
    public void testPrevCopy() {
        ...
        _fieldWriter.write( _encoder, _mapWriter, 100.0 );
        _fieldWriter.write( _encoder, _mapWriter, 100.0 );
        _mapWriter.end();
