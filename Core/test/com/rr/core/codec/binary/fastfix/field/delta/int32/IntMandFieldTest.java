...
public class IntMandFieldTest extends BaseTestCase {
    ...
    private IntMandReaderDelta  _fieldReader;
    private IntMandWriterDelta  _fieldWriter;
    ...
    public void setUp(){
        ...
        _fieldReader = new IntMandReaderDelta( "TestULong", 10018, 0 );
        _fieldWriter = new IntMandWriterDelta( "TestULong", 10018, 0 );
