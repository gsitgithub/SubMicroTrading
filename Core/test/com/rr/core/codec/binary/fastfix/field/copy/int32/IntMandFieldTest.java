...
public class IntMandFieldTest extends BaseTestCase {
    ...
    private IntMandReaderCopy      _fieldReader;
    private IntMandWriterCopy      _fieldWriter;
    ...
    public void setUp(){
        ...
        _fieldReader = new IntMandReaderCopy( "TestULong", 10018 );
        _fieldWriter = new IntMandWriterCopy( "TestULong", 10018 );
