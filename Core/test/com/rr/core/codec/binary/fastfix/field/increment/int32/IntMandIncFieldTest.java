...
public class IntMandIncFieldTest extends BaseTestCase {
    ...
    private IntMandReaderIncrement      _fieldReader;
    private IntMandWriterIncrement      _fieldWriter;
    ...
    public void setUp(){
        ...
        _fieldReader = new IntMandReaderIncrement( "TestULong", 10018 );
        _fieldWriter = new IntMandWriterIncrement( "TestULong", 10018 );
    ...
    public void testPrevCopy() {
        ...
        final int maxIdx = 1100;
        
        for( int i=1000 ; i < maxIdx ; i++ ) {
            _fieldWriter.write( _encoder, _mapWriter, i );
            assertEquals( i, _fieldWriter.getPreviousValue() );
        }
        
        _mapWriter.end();
        assertEquals( 26, _encoder.getCurrentIndex() );

        _decoder.start( _buf, 0, _encoder.getCurrentIndex() );
        
        _mapReader.readMap( _decoder );
        
        assertEquals( 15, _decoder.getCurrentIndex() );
