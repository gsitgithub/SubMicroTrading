...
public class LongOptNoOpFieldTest extends BaseTestCase {
    ...
    private LongOptReaderNoOp       _fieldReader;
    private LongOptWriterNoOp       _fieldWriter;
    ...
    public void setUp(){
        ...
        _fieldReader = new LongOptReaderNoOp( "TestULong", 10018 );
        _fieldWriter = new LongOptWriterNoOp( "TestULong", 10018 );
