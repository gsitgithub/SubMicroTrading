...
public class IntOptFieldTest extends BaseTestCase {
    ...
    private IntOptReaderDefault        _fieldReader;
    private IntOptWriterDefault        _fieldWriter;
    ...
    public void setUp(){
        ...
        _fieldReader = new IntOptReaderDefault( "TestUInt", 10018, 100 );
        _fieldWriter = new IntOptWriterDefault( "TestUInt", 10018, 100 );
