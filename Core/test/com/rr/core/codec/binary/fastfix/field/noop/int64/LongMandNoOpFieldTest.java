...
public class LongMandNoOpFieldTest extends BaseTestCase {
    ...
    private LongMandReaderNoOp      _fieldReader;
    private LongMandWriterNoOp      _fieldWriter;
    ...
    public void setUp(){
        ...
        _fieldReader = new LongMandReaderNoOp( "TestULong", 10018 );
        _fieldWriter = new LongMandWriterNoOp( "TestULong", 10018 );
