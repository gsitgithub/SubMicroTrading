...
public class ULongMandFieldTest extends BaseTestCase {
    ...
    private ULongMandReaderDefault     _fieldReader;
    private ULongMandWriterDefault     _fieldWriter;
    ...
    public void setUp(){
        ...
        _fieldReader = new ULongMandReaderDefault( "TestULong", 10018, 100 );
        _fieldWriter = new ULongMandWriterDefault( "TestULong", 10018, 100 );
