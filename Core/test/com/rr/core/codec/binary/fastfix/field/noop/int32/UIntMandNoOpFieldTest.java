...
public class UIntMandNoOpFieldTest extends BaseTestCase {
    ...
    private UIntMandReaderNoOp _fieldReader;
    private UIntMandWriterNoOp _fieldWriter;
    ...
    public void setUp(){
        ...
        _fieldReader = new UIntMandReaderNoOp( "TestULong", 10018 );
        _fieldWriter = new UIntMandWriterNoOp( "TestULong", 10018 );
    }
