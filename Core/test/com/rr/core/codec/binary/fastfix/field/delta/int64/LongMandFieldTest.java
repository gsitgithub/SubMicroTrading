...
public class LongMandFieldTest extends BaseTestCase {
    ...
    private LongMandReaderDelta      _fieldReader;
    private LongMandWriterDelta      _fieldWriter;
    ...
    public void setUp(){
        ...
        _fieldReader = new LongMandReaderDelta( "TestULong", 10018, 0 );
        _fieldWriter = new LongMandWriterDelta( "TestULong", 10018, 0 );
