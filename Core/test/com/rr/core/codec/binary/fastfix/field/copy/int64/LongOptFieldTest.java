...
public class LongOptFieldTest extends BaseTestCase {
    ...
    private LongOptReaderCopy       _fieldReader;
    private LongOptWriterCopy       _fieldWriter;
    ...
    public void setUp(){
        ...
        _fieldReader = new LongOptReaderCopy( "TestULong", 10018 );
        _fieldWriter = new LongOptWriterCopy( "TestULong", 10018 );
