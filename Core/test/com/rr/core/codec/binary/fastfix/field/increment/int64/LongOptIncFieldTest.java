...
public class LongOptIncFieldTest extends BaseTestCase {
    ...
    private LongOptReaderIncrement       _fieldReader;
    private LongOptWriterIncrement       _fieldWriter;
    ...
    public void setUp(){
        ...
        _fieldReader = new LongOptReaderIncrement( "TestULong", 10018 );
        _fieldWriter = new LongOptWriterIncrement( "TestULong", 10018 );
