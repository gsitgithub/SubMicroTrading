 ...
 *******************************************************************************/
package com.rr.core.codec.binary.fastfix.field.def.int32;
...
public class UIntOptFieldTest extends BaseTestCase {
    ...
    private UIntOptReaderDefault       _fieldReader;
    private UIntOptWriterDefault       _fieldWriter;
    ...
    public void setUp(){
        ...
        _fieldReader = new UIntOptReaderDefault( "TestULong", 10018, 100 );
        _fieldWriter = new UIntOptWriterDefault( "TestULong", 10018, 100 );
