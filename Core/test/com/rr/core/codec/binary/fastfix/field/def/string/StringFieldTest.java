 ...
 *******************************************************************************/
package com.rr.core.codec.binary.fastfix.field.def.string;
...
public class StringFieldTest extends BaseTestCase {
    ...
    private StringReaderDefault    _fieldReader;
    private StringWriterDefault    _fieldWriter;
    ...
    public void setUp(){
        ...
        _fieldReader = new StringReaderDefault( "TestULong", 10018, "ABCDEF" );
        _fieldWriter = new StringWriterDefault( "TestULong", 10018, "ABCDEF" );
