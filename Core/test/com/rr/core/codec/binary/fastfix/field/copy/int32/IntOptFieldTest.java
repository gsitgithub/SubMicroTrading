...
public class IntOptFieldTest extends BaseTestCase {
    ...
    private IntOptReaderCopy        _fieldReader;
    private IntOptWriterCopy        _fieldWriter;
    ...
    public void setUp(){
        ...
        _fieldReader = new IntOptReaderCopy( "TestUInt", 10018 );
        _fieldWriter = new IntOptWriterCopy( "TestUInt", 10018 );
