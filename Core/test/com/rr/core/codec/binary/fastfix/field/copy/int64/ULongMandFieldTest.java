...
public class ULongMandFieldTest extends BaseTestCase {
    ...
    private ULongMandReaderCopy     _fieldReader;
    private ULongMandWriterCopy     _fieldWriter;
    ...
    public void setUp(){
        ...
        _fieldReader = new ULongMandReaderCopy( "TestULong", 10018 );
        _fieldWriter = new ULongMandWriterCopy( "TestULong", 10018 );
