...
public class LongMandFieldTest extends BaseTestCase {
    ...
    private LongMandReaderCopy      _fieldReader;
    private LongMandWriterCopy      _fieldWriter;
    ...
    public void setUp(){
        ...
        _fieldReader = new LongMandReaderCopy( "TestULong", 10018 );
        _fieldWriter = new LongMandWriterCopy( "TestULong", 10018 );
