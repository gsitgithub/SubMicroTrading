...
public class IntMandNoOpFieldTest extends BaseTestCase {
    ...
    private IntMandReaderNoOp  _fieldReader;
    private IntMandWriterNoOp  _fieldWriter;
    ...
    public void setUp(){
        ...
        _fieldReader = new IntMandReaderNoOp( "TestULong", 10018 );
        _fieldWriter = new IntMandWriterNoOp( "TestULong", 10018 );
