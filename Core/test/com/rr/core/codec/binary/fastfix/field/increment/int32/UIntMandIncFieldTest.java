...
public class UIntMandIncFieldTest extends BaseTestCase {
    ...
    private UIntMandReaderIncrement     _fieldReader;
    private UIntMandWriterIncrement     _fieldWriter;
    ...
    public void setUp(){
        ...
        _fieldReader = new UIntMandReaderIncrement( "TestULong", 10018 );
        _fieldWriter = new UIntMandWriterIncrement( "TestULong", 10018 );
