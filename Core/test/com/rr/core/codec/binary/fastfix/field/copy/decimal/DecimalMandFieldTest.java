...
public class DecimalMandFieldTest extends BaseTestCase {
    ...
    private DecimalMandReaderCopy      _fieldReader;
    private DecimalMandWriterCopy      _fieldWriter;
    ...
    public void setUp(){
        ...
        _fieldReader = new DecimalMandReaderCopy( "TestULong", 10018 );
        _fieldWriter = new DecimalMandWriterCopy( "TestULong", 10018 );
