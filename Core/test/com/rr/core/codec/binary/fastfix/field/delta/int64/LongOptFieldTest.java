...
public class LongOptFieldTest extends BaseTestCase {
    ...
    private LongOptReaderDelta       _fieldReader;
    private LongOptWriterDelta       _fieldWriter;
    ...
    public void setUp(){
        ...
        _fieldReader = new LongOptReaderDelta( "TestULong", 10018, 0 );
        _fieldWriter = new LongOptWriterDelta( "TestULong", 10018, 0 );
