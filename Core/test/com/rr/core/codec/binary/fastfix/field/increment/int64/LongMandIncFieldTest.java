...
public class LongMandIncFieldTest extends BaseTestCase {
    ...
    private LongMandReaderIncrement      _fieldReader;
    private LongMandWriterIncrement      _fieldWriter;
    ...
    public void setUp(){
        ...
        _fieldReader = new LongMandReaderIncrement( "TestULong", 10018 );
        _fieldWriter = new LongMandWriterIncrement( "TestULong", 10018 );
