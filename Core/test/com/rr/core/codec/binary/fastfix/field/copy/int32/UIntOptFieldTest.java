...
public class UIntOptFieldTest extends BaseTestCase {
    ...
    private UIntOptReaderCopy       _fieldReader;
    private UIntOptWriterCopy       _fieldWriter;
    ...
    public void setUp(){
        ...
        _fieldReader = new UIntOptReaderCopy( "TestULong", 10018 );
        _fieldWriter = new UIntOptWriterCopy( "TestULong", 10018 );
