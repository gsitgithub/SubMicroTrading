...
public class UIntOptFieldTest extends BaseTestCase {
    ...
    private UIntOptReaderDelta       _fieldReader;
    private UIntOptWriterDelta       _fieldWriter;
    ...
    public void setUp(){
        ...
        _fieldReader = new UIntOptReaderDelta( "TestULong", 10018, 0 );
        _fieldWriter = new UIntOptWriterDelta( "TestULong", 10018, 0 );
